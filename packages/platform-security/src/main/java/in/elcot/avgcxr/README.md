# `packages/platform-security/src/main/java/in/elcot/avgcxr`
...
- [`platform-security/`](platform-security/README.md) — Folder holding the files listed below (part of `packages/platform-security/src/main/java/in/elcot/avgcxr`).
- [`platform.security/`](platform.security/README.md) — Folder holding the files listed below (part of `packages/platform-security/src/main/java/in/elcot/avgcxr`).
- [`platformsecurity/`](platformsecurity/README.md) — Folder holding the files listed below (part of `packages/platform-security/src/main/java/in/elcot/avgcxr`).
