# `packages/platform-security/src/main/java/in/elcot/avgcxr/platformsecurity/config`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-security/src/main/java/in/elcot/avgcxr/platformsecurity`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `SecurityAutoConfiguration.java` | Java | Security Auto Configuration — Spring configuration. |
