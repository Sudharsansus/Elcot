# `packages/platform-security/src/test/java/in/elcot/avgcxr/platformsecurity/jwt`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-security/src/test/java/in/elcot/avgcxr/platformsecurity`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `JwtTokenProviderForgedTest.java` | Java | Jwt Token Provider Forged Test — Java class. |
