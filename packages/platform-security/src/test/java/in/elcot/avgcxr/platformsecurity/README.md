# `packages/platform-security/src/test/java/in/elcot/avgcxr/platformsecurity`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-security/src/test/java/in/elcot/avgcxr`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`jwt/`](jwt/README.md) — Folder holding the files listed below (part of `packages/platform-security/src/test/java/in/elcot/avgcxr/platformsecurity`).
