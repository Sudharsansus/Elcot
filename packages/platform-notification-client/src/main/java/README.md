# `packages/platform-notification-client/src/main/java`
...
**Purpose:** Java package root.

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`in/`](in/README.md) — Java package segment (in.elcot.avgcxr — the backend base package).
