...
/**
 * Email delivery service for AVGC-XR Portal.
 * Supports bilingual HTML email templates (English/Tamil) using Thymeleaf.
 *
 * <p>Email templates are resolved from classpath:/templates/email/ with
 * language-specific suffixes (e.g., scheme-submitted_en.html, scheme-submitted_ta.html).</p>
 */
@Service
public class EmailService {
    ...
    public void sendHtmlEmail(String to, String subject, String templateName,
        ...
        try {
            ...
            log.info("Email sent successfully to: {}, template: {}, locale: {}", to, templateName, locale);
        } catch (MessagingException e) {
            log.error("Failed to send email to: {}, template: {}, error: {}", to, templateName, e.getMessage());
 ...
 * (Definition in EmailRequest.java)
 */
