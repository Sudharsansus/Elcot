# `packages/platform-notification-client/src/main/java/in/elcot/avgcxr/platform.notification.client`
...
| --- | --- | --- |
| `package-info.java` | Java | Notifications: SMS + Email gateway with template support |
