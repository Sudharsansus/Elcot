...
/**
 * Gateway interface for multi-channel notification delivery.
 * Provides a unified API for sending notifications across email and SMS channels.
 *
 * <p>Implementations route notifications to appropriate channel handlers
 * and support both synchronous and asynchronous delivery modes.</p>
 */
public interface NotificationGateway {
     ...
     * The notification is placed on a RabbitMQ queue for background processing.
     *
