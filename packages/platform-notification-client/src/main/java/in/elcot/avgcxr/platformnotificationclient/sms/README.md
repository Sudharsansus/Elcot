# `packages/platform-notification-client/src/main/java/in/elcot/avgcxr/platformnotificationclient/sms`
...
| --- | --- | --- |
| `SmsRequest.java` | Java | Sms Request — data transfer object (API payload). |
| `SmsService.java` | Java | Sms Service — service (business logic). |
