# `packages/platform-notification-client/src/main/java/in/elcot/avgcxr/platformnotificationclient/email`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-notification-client/src/main/java/in/elcot/avgcxr/platformnotificationclient`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `EmailRequest.java` | Java | Email Request — data transfer object (API payload). |
| `EmailService.java` | Java | Email Service — service (business logic). |
