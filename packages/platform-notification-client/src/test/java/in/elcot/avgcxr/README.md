# `packages/platform-notification-client/src/test/java/in/elcot/avgcxr`
...
- [`platform-notification-client/`](platform-notification-client/README.md) — Folder holding the files listed below (part of `packages/platform-notification-client/src/test/java/in/elcot/avgcxr`).
- [`platform.notification.client/`](platform.notification.client/README.md) — Folder holding the files listed below (part of `packages/platform-notification-client/src/test/java/in/elcot/avgcxr`).
