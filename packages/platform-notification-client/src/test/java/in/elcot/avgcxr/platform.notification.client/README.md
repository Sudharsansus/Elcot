# `packages/platform-notification-client/src/test/java/in/elcot/avgcxr/platform.notification.client`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-notification-client/src/test/java/in/elcot/avgcxr`).
