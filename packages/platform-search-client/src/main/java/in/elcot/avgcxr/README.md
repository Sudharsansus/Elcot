# `packages/platform-search-client/src/main/java/in/elcot/avgcxr`
...
- [`platform-search-client/`](platform-search-client/README.md) — Folder holding the files listed below (part of `packages/platform-search-client/src/main/java/in/elcot/avgcxr`).
- [`platform.search.client/`](platform.search.client/README.md) — Folder holding the files listed below (part of `packages/platform-search-client/src/main/java/in/elcot/avgcxr`).
- [`platformsearchclient/`](platformsearchclient/README.md) — Folder holding the files listed below (part of `packages/platform-search-client/src/main/java/in/elcot/avgcxr`).
