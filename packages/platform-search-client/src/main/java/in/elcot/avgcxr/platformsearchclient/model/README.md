# `packages/platform-search-client/src/main/java/in/elcot/avgcxr/platformsearchclient/model`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-search-client/src/main/java/in/elcot/avgcxr/platformsearchclient`).
