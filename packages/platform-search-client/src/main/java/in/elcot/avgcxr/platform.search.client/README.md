# `packages/platform-search-client/src/main/java/in/elcot/avgcxr/platform.search.client`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-search-client/src/main/java/in/elcot/avgcxr`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `package-info.java` | Java | Search: Elasticsearch client wrapper for indexing and searching |
