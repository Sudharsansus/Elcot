# `packages/platform-search-client/src/test/java/in/elcot/avgcxr`
...
- [`platform-search-client/`](platform-search-client/README.md) — Folder holding the files listed below (part of `packages/platform-search-client/src/test/java/in/elcot/avgcxr`).
- [`platform.search.client/`](platform.search.client/README.md) — Folder holding the files listed below (part of `packages/platform-search-client/src/test/java/in/elcot/avgcxr`).
