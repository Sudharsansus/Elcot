# `packages/platform-cms-client/src/test/java/in/elcot/avgcxr/platform-cms-client`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-cms-client/src/test/java/in/elcot/avgcxr`).
