# `packages/platform-cms-client/src/test/java/in/elcot/avgcxr`
...
- [`platform-cms-client/`](platform-cms-client/README.md) — Folder holding the files listed below (part of `packages/platform-cms-client/src/test/java/in/elcot/avgcxr`).
- [`platform.cms.client/`](platform.cms.client/README.md) — Folder holding the files listed below (part of `packages/platform-cms-client/src/test/java/in/elcot/avgcxr`).
