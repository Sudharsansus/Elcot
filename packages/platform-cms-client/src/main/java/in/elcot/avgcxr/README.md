# `packages/platform-cms-client/src/main/java/in/elcot/avgcxr`
...
- [`platform-cms-client/`](platform-cms-client/README.md) — Folder holding the files listed below (part of `packages/platform-cms-client/src/main/java/in/elcot/avgcxr`).
- [`platform.cms.client/`](platform.cms.client/README.md) — Folder holding the files listed below (part of `packages/platform-cms-client/src/main/java/in/elcot/avgcxr`).
- [`platformcmsclient/`](platformcmsclient/README.md) — Folder holding the files listed below (part of `packages/platform-cms-client/src/main/java/in/elcot/avgcxr`).
