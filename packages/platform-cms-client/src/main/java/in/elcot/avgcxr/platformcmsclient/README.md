# `packages/platform-cms-client/src/main/java/in/elcot/avgcxr/platformcmsclient`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-cms-client/src/main/java/in/elcot/avgcxr`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `StrapiClient.java` | Java | Strapi Client — Java class. |

## Subfolders (1)

- [`model/`](model/README.md) — Folder holding the files listed below (part of `packages/platform-cms-client/src/main/java/in/elcot/avgcxr/platformcmsclient`).
