# `packages/platform-testing/src/main/java/in/elcot/avgcxr/platform-testing`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-testing/src/main/java/in/elcot/avgcxr`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `package-info.java` | Java | Platform Testing - Shared test infrastructure. <p>Provides base test classes, test data builders, and test utilities used across all bounded context test suites in the AVGC-XR Portal. |
