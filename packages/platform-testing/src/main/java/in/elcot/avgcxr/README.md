# `packages/platform-testing/src/main/java/in/elcot/avgcxr`
...
- [`platform-testing/`](platform-testing/README.md) — Folder holding the files listed below (part of `packages/platform-testing/src/main/java/in/elcot/avgcxr`).
- [`platform.testing/`](platform.testing/README.md) — Folder holding the files listed below (part of `packages/platform-testing/src/main/java/in/elcot/avgcxr`).
