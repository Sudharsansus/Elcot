# `packages/platform-testing/src/test/java/in/elcot/avgcxr/platform-testing`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-testing/src/test/java/in/elcot/avgcxr`).
