# `packages/platform-observability/src/test/java/in/elcot/avgcxr`
...
- [`platform-observability/`](platform-observability/README.md) — Folder holding the files listed below (part of `packages/platform-observability/src/test/java/in/elcot/avgcxr`).
- [`platform.observability/`](platform.observability/README.md) — Folder holding the files listed below (part of `packages/platform-observability/src/test/java/in/elcot/avgcxr`).
