# `packages/platform-observability/src/test/java/in/elcot/avgcxr/platform.observability`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-observability/src/test/java/in/elcot/avgcxr`).
