# `packages/platform-observability/src/main/java/in/elcot/avgcxr/platform.observability`
...
| --- | --- | --- |
| `package-info.java` | Java | Observability: structured logging, metrics, tracing, health checks |
