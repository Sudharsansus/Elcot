...
/**
 * Structured JSON logger for AVGC-XR Portal.
 * Outputs log entries as single-line JSON objects for easy parsing by
 * Elasticsearch and centralized log management systems.
 *
 * <p>Log format complies with Tamil Nadu government IT audit requirements.</p>
 *
 * <p>Example output:</p>
 * <pre>
