# `packages/platform-observability/src/main/java/in/elcot/avgcxr`
...
- [`platform-observability/`](platform-observability/README.md) — Folder holding the files listed below (part of `packages/platform-observability/src/main/java/in/elcot/avgcxr`).
- [`platform.observability/`](platform.observability/README.md) — Folder holding the files listed below (part of `packages/platform-observability/src/main/java/in/elcot/avgcxr`).
- [`platformobservability/`](platformobservability/README.md) — Folder holding the files listed below (part of `packages/platform-observability/src/main/java/in/elcot/avgcxr`).
