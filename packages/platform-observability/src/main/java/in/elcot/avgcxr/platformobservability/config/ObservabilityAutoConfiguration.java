...
import in.elcot.avgcxr.platformobservability.logging.StructuredJsonLogger;
...
/**
 * Auto-configuration for observability infrastructure.
 * Registers correlation ID filter and configures structured logging.
 */
@AutoConfiguration
