# `packages/platform-observability/src/main/java/in/elcot/avgcxr/platformobservability/logging`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-observability/src/main/java/in/elcot/avgcxr/platformobservability`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `StructuredJsonLogger.java` | Java | Structured Json Logger — Java class. |
