# `packages/platform-core/src/main/java/in/elcot/avgcxr/platformcore/error`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-core/src/main/java/in/elcot/avgcxr/platformcore`).

## Files (3)

| File | Type | What it does |
| --- | --- | --- |
| `ConflictException.java` | Java | Conflict Exception — exception type. |
| `DomainException.java` | Java | Domain Exception — exception type. |
| `NotFoundException.java` | Java | Not Found Exception — exception type. |
