# `packages/platform-core/src/main/java/in/elcot/avgcxr/platform.core`
...
| --- | --- | --- |
| `package-info.java` | Java | Core domain primitives: error hierarchy, auditable entities, aggregate roots |
