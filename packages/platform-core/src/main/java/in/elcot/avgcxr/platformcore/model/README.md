# `packages/platform-core/src/main/java/in/elcot/avgcxr/platformcore/model`
...
| --- | --- | --- |
| `AbstractAggregateRoot.java` | Java | Abstract Aggregate Root — Java class. |
| `AuditableEntity.java` | Java | Auditable Entity — JPA entity (maps to a database table). |
