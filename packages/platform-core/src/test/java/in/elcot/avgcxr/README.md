# `packages/platform-core/src/test/java/in/elcot/avgcxr`
...
- [`platform-core/`](platform-core/README.md) — Folder holding the files listed below (part of `packages/platform-core/src/test/java/in/elcot/avgcxr`).
- [`platform.core/`](platform.core/README.md) — Folder holding the files listed below (part of `packages/platform-core/src/test/java/in/elcot/avgcxr`).
