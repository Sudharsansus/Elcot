# `packages/platform-core/src/test/java/in/elcot/avgcxr/platform-core`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-core/src/test/java/in/elcot/avgcxr`).
