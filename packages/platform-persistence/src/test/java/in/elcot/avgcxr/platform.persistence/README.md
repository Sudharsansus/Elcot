# `packages/platform-persistence/src/test/java/in/elcot/avgcxr/platform.persistence`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-persistence/src/test/java/in/elcot/avgcxr`).
