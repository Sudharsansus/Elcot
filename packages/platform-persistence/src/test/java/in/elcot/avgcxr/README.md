# `packages/platform-persistence/src/test/java/in/elcot/avgcxr`
...
- [`platform-persistence/`](platform-persistence/README.md) — Folder holding the files listed below (part of `packages/platform-persistence/src/test/java/in/elcot/avgcxr`).
- [`platform.persistence/`](platform.persistence/README.md) — Folder holding the files listed below (part of `packages/platform-persistence/src/test/java/in/elcot/avgcxr`).
