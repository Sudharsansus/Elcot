...
/**
 * Auto-configuration for JPA persistence layer.
 * Enables JPA auditing, entity scanning, and repository configuration.
 *
 * <p>All bounded contexts benefit from this auto-configuration, which sets up
 * createdAt/updatedAt audit columns and soft delete support automatically.</p>
 */
@AutoConfiguration
...
public class PersistenceAutoConfiguration {
     ...
     * Reads the user ID from the security context or falls back to "system".
     *
