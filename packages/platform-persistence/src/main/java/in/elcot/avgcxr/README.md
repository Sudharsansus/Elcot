# `packages/platform-persistence/src/main/java/in/elcot/avgcxr`
...
- [`platform-persistence/`](platform-persistence/README.md) — Folder holding the files listed below (part of `packages/platform-persistence/src/main/java/in/elcot/avgcxr`).
- [`platform.persistence/`](platform.persistence/README.md) — Folder holding the files listed below (part of `packages/platform-persistence/src/main/java/in/elcot/avgcxr`).
- [`platformpersistence/`](platformpersistence/README.md) — Folder holding the files listed below (part of `packages/platform-persistence/src/main/java/in/elcot/avgcxr`).
