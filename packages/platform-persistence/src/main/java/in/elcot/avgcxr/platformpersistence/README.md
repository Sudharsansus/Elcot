# `packages/platform-persistence/src/main/java/in/elcot/avgcxr/platformpersistence`
...
- [`config/`](config/README.md) — Folder holding the files listed below (part of `packages/platform-persistence/src/main/java/in/elcot/avgcxr/platformpersistence`).
