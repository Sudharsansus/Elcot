...
public class DomainEvent {
    ...
    /**
     * Compatibility constructor for subclasses that pass aggregate id, event type,
     * timestamp, entity name, and metadata.
     */
    public DomainEvent(UUID aggregateId, String eventType, LocalDateTime timestamp,
    ...
    /**
     * Compatibility constructor for subclasses that pass aggregate id, event type,
     * timestamp, and metadata (no entity name).
     */
    public DomainEvent(UUID aggregateId, String eventType, LocalDateTime timestamp,
