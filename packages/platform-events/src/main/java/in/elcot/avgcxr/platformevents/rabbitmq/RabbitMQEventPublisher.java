...
/**
 * Publishes domain events to the configured RabbitMQ exchange.
 * The RabbitTemplate dependency is lazy-loaded so this bean can be
 * instantiated in environments where RabbitMQ is not available.
 */
@Slf4j
@Component
