# `packages/platform-events/src/main/java/in/elcot/avgcxr/platformevents/domain`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-events/src/main/java/in/elcot/avgcxr/platformevents`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `DomainEvent.java` | Java | Domain Event — Java class. |
