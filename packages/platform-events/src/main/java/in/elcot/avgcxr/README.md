# `packages/platform-events/src/main/java/in/elcot/avgcxr`
...
- [`platform-events/`](platform-events/README.md) — Folder holding the files listed below (part of `packages/platform-events/src/main/java/in/elcot/avgcxr`).
- [`platform.events/`](platform.events/README.md) — Folder holding the files listed below (part of `packages/platform-events/src/main/java/in/elcot/avgcxr`).
- [`platformevents/`](platformevents/README.md) — Folder holding the files listed below (part of `packages/platform-events/src/main/java/in/elcot/avgcxr`).
