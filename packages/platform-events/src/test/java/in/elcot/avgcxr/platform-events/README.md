# `packages/platform-events/src/test/java/in/elcot/avgcxr/platform-events`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-events/src/test/java/in/elcot/avgcxr`).
