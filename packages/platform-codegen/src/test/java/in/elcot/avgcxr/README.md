# `packages/platform-codegen/src/test/java/in/elcot/avgcxr`
...
- [`platform-codegen/`](platform-codegen/README.md) — Folder holding the files listed below (part of `packages/platform-codegen/src/test/java/in/elcot/avgcxr`).
- [`platform.codegen/`](platform.codegen/README.md) — Folder holding the files listed below (part of `packages/platform-codegen/src/test/java/in/elcot/avgcxr`).
