# `packages/platform-codegen/src/test/java/in/elcot/avgcxr/platform-codegen`
...
**Purpose:** Folder holding the files listed below (part of `packages/platform-codegen/src/test/java/in/elcot/avgcxr`).
