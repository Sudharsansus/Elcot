...
**Purpose:** Folder holding the files listed below (part of `.github`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`java-upgrade/`](java-upgrade/README.md) — Folder holding the files listed below (part of `.github/modernize`).
