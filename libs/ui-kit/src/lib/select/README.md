...
| --- | --- | --- |
| `select.component.html` | HTML | HTML template or page. |
| `select.component.scss` | Sass | Sass stylesheet. |
| `select.component.spec.ts` | TypeScript | Unit test specification for the matching source file. |
| `select.component.ts` | TypeScript | Select — UI component (template + logic for a screen or widget). |
