...
| --- | --- | --- |
| `card.component.html` | HTML | HTML template or page. |
| `card.component.scss` | Sass | Sass stylesheet. |
| `card.component.spec.ts` | TypeScript | Unit test specification for the matching source file. |
| `card.component.ts` | TypeScript | Card — UI component (template + logic for a screen or widget). |
