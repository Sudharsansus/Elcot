...
| --- | --- | --- |
| `chart.component.html` | HTML | HTML template or page. |
| `chart.component.scss` | Sass | Sass stylesheet. |
| `chart.component.spec.ts` | TypeScript | Unit test specification for the matching source file. |
| `chart.component.ts` | TypeScript | Chart — UI component (template + logic for a screen or widget). |
