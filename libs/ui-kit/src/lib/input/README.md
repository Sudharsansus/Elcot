...
| --- | --- | --- |
| `input.component.html` | HTML | HTML template or page. |
| `input.component.scss` | Sass | Sass stylesheet. |
| `input.component.spec.ts` | TypeScript | Unit test specification for the matching source file. |
| `input.component.ts` | TypeScript | Input — UI component (template + logic for a screen or widget). |
