...
| --- | --- | --- |
| `button.component.html` | HTML | HTML template or page. |
| `button.component.scss` | Sass | Sass stylesheet. |
| `button.component.spec.ts` | TypeScript | Unit test specification for the matching source file. |
| `button.component.ts` | TypeScript | Button — UI component (template + logic for a screen or widget). |
