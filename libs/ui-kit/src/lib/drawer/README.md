...
| --- | --- | --- |
| `drawer.component.html` | HTML | HTML template or page. |
| `drawer.component.scss` | Sass | Sass stylesheet. |
| `drawer.component.spec.ts` | TypeScript | Unit test specification for the matching source file. |
| `drawer.component.ts` | TypeScript | Drawer — UI component (template + logic for a screen or widget). |
