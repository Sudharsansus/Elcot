# `apps/worker/src/test/java/in/elcot/avgcxr/worker`
...
**Purpose:** Folder holding the files listed below (part of `apps/worker/src/test/java/in/elcot/avgcxr`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `WorkerApplicationTests.java` | Java | Worker Application Tests — Java class. |
