# `apps/worker/src/main/java/in/elcot/avgcxr`
...
- [`worker/`](worker/README.md) — Folder holding the files listed below (part of `apps/worker/src/main/java/in/elcot/avgcxr`).
