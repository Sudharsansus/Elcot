# `apps/admin-portal/src/app/features/users`
...
**Purpose:** User-management feature (admin).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `users.routes.ts` | TypeScript | Route definitions for the Users area (lazy-loaded screens). |
