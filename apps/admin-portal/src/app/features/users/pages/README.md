# `apps/admin-portal/src/app/features/users/pages`
...
| --- | --- | --- |
| `user-management.component.html` | HTML | HTML template or page. |
| `user-management.component.ts` | TypeScript | User Management — UI component (template + logic for a screen or widget). |
