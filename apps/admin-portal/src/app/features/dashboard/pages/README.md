# `apps/admin-portal/src/app/features/dashboard/pages`
...
| --- | --- | --- |
| `admin-dashboard.component.html` | HTML | HTML template or page. |
| `admin-dashboard.component.ts` | TypeScript | Admin Dashboard — UI component (template + logic for a screen or widget). |
