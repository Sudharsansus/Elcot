...
**Purpose:** Static assets served as-is (images, fonts, icons).

_No files directly in this folder (see subfolders below)._

## Subfolders (2)

- [`i18n/`](i18n/README.md) — Folder holding the files listed below (part of `apps/admin-portal/src/assets`).
- [`images/`](images/README.md) — Folder holding the files listed below (part of `apps/admin-portal/src/assets`).
