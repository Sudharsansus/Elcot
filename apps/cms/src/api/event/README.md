...
- [`content-types/`](content-types/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/event`).
- [`controllers/`](controllers/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/event`).
- [`routes/`](routes/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/event`).
