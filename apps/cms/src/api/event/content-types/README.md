# `apps/cms/src/api/event/content-types`
...
**Purpose:** Folder holding the files listed below (part of `apps/cms/src/api/event`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`event/`](event/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/event/content-types`).
