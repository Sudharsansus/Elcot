...
**Purpose:** Folder holding the files listed below (part of `apps/cms/src/api/scheme`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `sample-schemes.json` | JSON | JSON data / configuration. |
