...
- [`content-types/`](content-types/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/testimonial`).
- [`controllers/`](controllers/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/testimonial`).
- [`routes/`](routes/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/testimonial`).
