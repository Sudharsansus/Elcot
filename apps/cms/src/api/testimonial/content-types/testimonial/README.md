# `apps/cms/src/api/testimonial/content-types/testimonial`
...
**Purpose:** Folder holding the files listed below (part of `apps/cms/src/api/testimonial/content-types`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `schema.json` | JSON | JSON data / configuration. |
