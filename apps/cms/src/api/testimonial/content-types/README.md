# `apps/cms/src/api/testimonial/content-types`
...
**Purpose:** Folder holding the files listed below (part of `apps/cms/src/api/testimonial`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`testimonial/`](testimonial/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/testimonial/content-types`).
