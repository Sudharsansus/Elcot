# `apps/cms/src/api/news-item/content-types`
...
**Purpose:** Folder holding the files listed below (part of `apps/cms/src/api/news-item`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`news-item/`](news-item/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/news-item/content-types`).
