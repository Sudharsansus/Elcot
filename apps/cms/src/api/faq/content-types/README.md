# `apps/cms/src/api/faq/content-types`
...
**Purpose:** Folder holding the files listed below (part of `apps/cms/src/api/faq`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`faq/`](faq/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/faq/content-types`).
