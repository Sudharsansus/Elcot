# `apps/cms/src/api/resource/content-types`
...
**Purpose:** Folder holding the files listed below (part of `apps/cms/src/api/resource`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`resource/`](resource/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/resource/content-types`).
