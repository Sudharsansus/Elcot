...
- [`content-types/`](content-types/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/resource`).
- [`controllers/`](controllers/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/resource`).
- [`routes/`](routes/README.md) — Folder holding the files listed below (part of `apps/cms/src/api/resource`).
