# `apps/api/src/test/java/in/elcot/avgcxr/policy/application`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/test/java/in/elcot/avgcxr/policy`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`domain/`](domain/README.md) — Folder holding the files listed below (part of `apps/api/src/test/java/in/elcot/avgcxr/policy/application`).
