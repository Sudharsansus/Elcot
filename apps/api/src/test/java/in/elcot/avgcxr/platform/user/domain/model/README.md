# `apps/api/src/test/java/in/elcot/avgcxr/platform/user/domain/model`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/test/java/in/elcot/avgcxr/platform/user/domain`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `UserTest.java` | Java | User Test — Java class. |
