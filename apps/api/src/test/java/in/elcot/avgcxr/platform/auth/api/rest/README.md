# `apps/api/src/test/java/in/elcot/avgcxr/platform/auth/api/rest`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/test/java/in/elcot/avgcxr/platform/auth/api`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `AuthControllerIT.java` | Java | Auth Controller IT — Java class. |
