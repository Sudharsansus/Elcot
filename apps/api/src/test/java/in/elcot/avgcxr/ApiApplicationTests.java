...
/**
 * Full Spring context integration test. Requires Postgres, Redis, RabbitMQ,
 * Elasticsearch and MinIO to be reachable on localhost.
 *
 * <p>Skipped by default to allow {@code mvn test} to pass in CI / local
 * builds without docker. Run explicitly with:</p>
 * <pre>
