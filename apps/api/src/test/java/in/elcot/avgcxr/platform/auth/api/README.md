# `apps/api/src/test/java/in/elcot/avgcxr/platform/auth/api`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/test/java/in/elcot/avgcxr/platform/auth`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`rest/`](rest/README.md) — Folder holding the files listed below (part of `apps/api/src/test/java/in/elcot/avgcxr/platform/auth/api`).
