# `apps/api/src/test/java/in/elcot/avgcxr/platform/user/domain`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/test/java/in/elcot/avgcxr/platform/user`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`model/`](model/README.md) — Folder holding the files listed below (part of `apps/api/src/test/java/in/elcot/avgcxr/platform/user/domain`).
