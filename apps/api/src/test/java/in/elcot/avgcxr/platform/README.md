# `apps/api/src/test/java/in/elcot/avgcxr/platform`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/test/java/in/elcot/avgcxr`).
...
- [`user/`](user/README.md) — Folder holding the files listed below (part of `apps/api/src/test/java/in/elcot/avgcxr/platform`).
