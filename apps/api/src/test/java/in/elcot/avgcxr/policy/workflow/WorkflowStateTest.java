...
/**
 * Unit tests for the workflow state machine. The AVGC-XR workflow engine uses
 * Flowable BPMN 2.0 with a maker-checker-reviewer-approver pattern; the
 * externally observable lifecycle is captured by {@link WorkflowStatus}.
 */
