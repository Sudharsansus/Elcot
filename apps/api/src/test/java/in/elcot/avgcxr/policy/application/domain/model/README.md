# `apps/api/src/test/java/in/elcot/avgcxr/policy/application/domain/model`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/test/java/in/elcot/avgcxr/policy/application/domain`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `ApplicationTest.java` | Java | Application Test — Java class. |
