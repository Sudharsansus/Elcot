# `apps/api/src/main/resources/processes`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/resources`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `applicationReview.bpmn` | BPMN | Project file. |
| `schemeApproval.bpmn` | BPMN | Project file. |
