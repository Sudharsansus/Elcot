-- V10: Ecosystem tables (business_connect, talent_connect, freelancer_registry)
...
CREATE INDEX IF NOT EXISTS idx_bc_district ON business_connect(district);
CREATE INDEX IF NOT EXISTS idx_bc_subsector ON business_connect(sub_sector);
...
CREATE INDEX IF NOT EXISTS idx_tc_district ON talent_connect(district);
CREATE INDEX IF NOT EXISTS idx_tc_subsector ON talent_connect(sub_sector);
...
CREATE INDEX IF NOT EXISTS idx_fr_district ON freelancer_registry(district);
