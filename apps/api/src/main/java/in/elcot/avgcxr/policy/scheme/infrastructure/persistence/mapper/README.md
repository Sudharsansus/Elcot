# `apps/api/src/main/java/in/elcot/avgcxr/policy/scheme/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `SchemeMapper.java` | Java | Scheme Mapper — mapper (entity ↔ DTO conversion). |
