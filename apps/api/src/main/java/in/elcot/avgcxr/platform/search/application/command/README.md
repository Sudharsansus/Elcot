# `apps/api/src/main/java/in/elcot/avgcxr/platform/search/application/command`
...
| --- | --- | --- |
| `CreateSearchCommand.java` | Java | Create Search Command — Java class. |
| `CreateSearchResultCommand.java` | Java | Create Search Result Command — Java class. |
| `UpdateSearchCommand.java` | Java | Update Search Command — Java class. |
