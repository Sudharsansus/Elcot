# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/freelancerregistry/api/messaging`
...
| --- | --- | --- |
| `FreelancerregistryEventConsumer.java` | Java | Freelancerregistry Event Consumer — Java class. |
