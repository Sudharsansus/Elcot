# `apps/api/src/main/java/in/elcot/avgcxr/policy/workflow/api`
...
- [`messaging/`](messaging/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/workflow/api`).
- [`rest/`](rest/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/workflow/api`).
