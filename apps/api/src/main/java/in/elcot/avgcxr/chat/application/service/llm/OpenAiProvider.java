 ...
 *
 * <p>Activated when {@code avgcxr.llm.provider=openai} AND {@code avgcxr.llm.openai.api-key} is
 * set.
 *
 * <p>Default model: gpt-4o-mini (cheap, fast, good enough for portal help). Override with {@code
 * avgcxr.llm.openai.model}.
 */
@Service
    ...
    try {
      ...
      Map<String, Object> body =
          Map.of(
              ...
              payload,
              "temperature",
              options != null ? options.temperature() : 0.3,
              "max_tokens",
              options != null ? options.maxTokens() : 1024);
