 ...
 *
 * <p>Flowable's Spring Boot starter auto-configures the ProcessEngine and all the service beans
 * (RepositoryService, TaskService, etc.). This config adds an explicit readiness check: on
 * application context refresh we enumerate the deployed process definitions and log them so a
 * missing BPMN is immediately visible at boot.
 */
@Configuration
