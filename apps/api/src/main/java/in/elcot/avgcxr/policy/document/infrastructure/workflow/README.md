# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/infrastructure/workflow`
...
**Purpose:** Workflow / process-management feature.

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `DocumentWorkflowHandler.java` | Java | Document Workflow Handler — handler component. |
