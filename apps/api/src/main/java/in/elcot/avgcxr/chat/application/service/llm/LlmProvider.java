...
/**
 * LLM provider abstraction. Implementations: - OpenAiProvider (GPT-4o, GPT-4o-mini, GPT-3.5-turbo)
 * - AnthropicProvider (Claude Haiku, Sonnet, Opus) - OllamaProvider (local models: Llama 3,
 * Mistral, Qwen) - RuleBasedLlmProvider (fallback when no API key configured)
 *
 * <p>Switch via configuration: {@code avgcxr.llm.provider=openai|anthropic|ollama|rule-based}.
 */
public interface LlmProvider {
  ...
  /**
   * Streaming variant. Calls {@code onChunk} for each token; completes with full text. Default impl
