# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/application/port/output`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/application/port`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `NotificationRepositoryPort.java` | Java | Notification Repository Port — data-access / port (persistence or external boundary). |
