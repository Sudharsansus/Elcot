# `apps/api/src/main/java/in/elcot/avgcxr/policy/application/infrastructure/persistence/entity`
...
| --- | --- | --- |
| `ApplicationEntity.java` | Java | Application Entity — JPA entity (maps to a database table). |
