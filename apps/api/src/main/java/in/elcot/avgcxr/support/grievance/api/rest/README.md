# `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/api/rest`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/api`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `GrievanceController.java` | Java | Grievance Controller — REST controller (defines HTTP endpoints). |

## Subfolders (1)

- [`dto/`](dto/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/api/rest`).
