...
/**
 * Immutable DPDP consent record for one user × consent-type × policy-version.
 * Once granted/revoked, the row is never updated; new decisions create new rows.
 *
 * <p>Stored in user_consents table per V24 migration. Required for DPDP Act 2023
 * compliance (Sections 6, 7, 8 — consent for data processing).</p>
 */
