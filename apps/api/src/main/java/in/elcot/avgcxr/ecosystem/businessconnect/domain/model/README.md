# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/businessconnect/domain/model`
...
| --- | --- | --- |
| `Businessconnect.java` | Java | Businessconnect — Java class. |
| `BusinessconnectId.java` | Java | Businessconnect Id — Java class. |
| `Company.java` | Java | Company — Java class. |
