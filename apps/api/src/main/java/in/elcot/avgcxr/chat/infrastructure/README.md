# `apps/api/src/main/java/in/elcot/avgcxr/chat/infrastructure`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat`).

_No files directly in this folder (see subfolders below)._

## Subfolders (2)

- [`config/`](config/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat/infrastructure`).
- [`persistence/`](persistence/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat/infrastructure`).
