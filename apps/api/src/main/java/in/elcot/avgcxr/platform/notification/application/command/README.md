# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/application/command`
...
| --- | --- | --- |
| `CreateNotificationCommand.java` | Java | Create Notification Command — Java class. |
| `UpdateNotificationCommand.java` | Java | Update Notification Command — Java class. |
