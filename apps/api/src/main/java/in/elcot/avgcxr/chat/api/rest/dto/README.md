# `apps/api/src/main/java/in/elcot/avgcxr/chat/api/rest/dto`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat/api/rest`).

_No files directly in this folder (see subfolders below)._

## Subfolders (2)

- [`request/`](request/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat/api/rest/dto`).
- [`response/`](response/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat/api/rest/dto`).
