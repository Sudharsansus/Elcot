...
public class WorkflowController {
  ...
  public ResponseEntity<WorkflowResponse> create(
    ...
    Workflow entity =
        service.create(new CreateWorkflowCommand(request.name(), request.description(), "system"));
  ...
  public ResponseEntity<WorkflowResponse> update(
      @PathVariable String id, @Valid @RequestBody UpdateWorkflowRequest request) {
    Workflow entity =
        service.update(
            WorkflowId.of(id), new UpdateWorkflowCommand(request.name(), request.description()));
  ...
  private Map<String, Object> toTaskMap(Task t) {
    ...
    m.put(
        "createTime", t.getCreateTime() != null ? t.getCreateTime().toInstant().toString() : null);
    return m;
  }
}
