# `apps/api/src/main/java/in/elcot/avgcxr/policy/scheme/api/rest/dto/request`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/scheme/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `CreateSchemeRequest.java` | Java | Create Scheme Request — data transfer object (API payload). |
| `UpdateSchemeRequest.java` | Java | Update Scheme Request — data transfer object (API payload). |
