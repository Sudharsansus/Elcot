# `apps/api/src/main/java/in/elcot/avgcxr/chat/application/port`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat/application`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`output/`](output/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat/application/port`).
