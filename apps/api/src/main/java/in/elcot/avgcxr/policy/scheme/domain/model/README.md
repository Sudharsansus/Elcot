# `apps/api/src/main/java/in/elcot/avgcxr/policy/scheme/domain/model`
...
| --- | --- | --- |
| `Scheme.java` | Java | Scheme — Java class. |
| `SchemeId.java` | Java | Scheme Id — Java class. |
| `SchemeStatus.java` | Java | Scheme Status — Java class. |
