# `apps/api/src/main/java/in/elcot/avgcxr/platform/cms`
...
- [`api/`](api/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/cms`).
