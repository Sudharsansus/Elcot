...
/**
 * Frontend contract (libs/api-contracts user.model.ts): { id, username, email, mobileNumber,
 * fullName, fullNameTamil?, roles, status, department?, designation?, district?, lastLoginAt?,
 * createdAt, updatedAt, profileCompleted, avatarUrl? }
 *
 * <p>Now uses LOWER_CAMEL_CASE (default Jackson) so Java {@code mobileNumber} maps to JSON {@code
