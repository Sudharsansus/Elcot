...
import in.elcot.avgcxr.platform.search.domain.exception.DuplicateSearchException;
...
public class SearchService implements CreateSearchUseCase, GetSearchUseCase {
    ...
    public SearchService(SearchRepositoryPort repository) { this.repository = repository; }
    ...
    @Override
    public Optional<Search> findById(SearchId id) { return repository.findById(id); }
    ...
    @Transactional
    public void delete(SearchId id) { repository.deleteById(id); }
}
