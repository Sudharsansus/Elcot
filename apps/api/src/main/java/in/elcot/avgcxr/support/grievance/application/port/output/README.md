# `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/application/port/output`
...
| --- | --- | --- |
| `GrievanceRepositoryPort.java` | Java | Grievance Repository Port — data-access / port (persistence or external boundary). |
