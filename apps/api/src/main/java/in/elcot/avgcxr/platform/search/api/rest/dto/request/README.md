# `apps/api/src/main/java/in/elcot/avgcxr/platform/search/api/rest/dto/request`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/search/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `CreateSearchRequest.java` | Java | Create Search Request — data transfer object (API payload). |
| `UpdateSearchRequest.java` | Java | Update Search Request — data transfer object (API payload). |
