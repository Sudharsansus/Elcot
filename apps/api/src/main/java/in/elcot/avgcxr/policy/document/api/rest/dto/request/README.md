# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/api/rest/dto/request`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/document/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `CreateDocumentRequest.java` | Java | Create Document Request — data transfer object (API payload). |
| `UpdateDocumentRequest.java` | Java | Update Document Request — data transfer object (API payload). |
