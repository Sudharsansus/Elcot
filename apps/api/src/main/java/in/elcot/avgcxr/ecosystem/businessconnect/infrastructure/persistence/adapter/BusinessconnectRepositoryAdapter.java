...
public class BusinessconnectRepositoryAdapter implements BusinessconnectRepositoryPort {
  ...
  public BusinessconnectRepositoryAdapter(
      JpaBusinessconnectRepository jpaRepo, BusinessconnectMapper mapper) {
    this.jpaRepo = jpaRepo;
    this.mapper = mapper;
  }

  @Override
  public Businessconnect save(Businessconnect entity) {
  ...
  @Override
  public void deleteById(BusinessconnectId id) {
    jpaRepo.deleteById(id.toString());
  }

  @Override
  public boolean existsById(BusinessconnectId id) {
