# `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/infrastructure/persistence/repository`
...
| --- | --- | --- |
| `JpaDashboardDataRepository.java` | Java | Jpa Dashboard Data Repository — data-access / port (persistence or external boundary). |
