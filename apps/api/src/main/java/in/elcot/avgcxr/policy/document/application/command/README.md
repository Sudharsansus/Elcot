# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/application/command`
...
| --- | --- | --- |
| `CreateDocumentCommand.java` | Java | Create Document Command — Java class. |
| `ProcessDocumentCommand.java` | Java | Process Document Command — Java class. |
| `UpdateDocumentCommand.java` | Java | Update Document Command — Java class. |
