# `apps/api/src/main/java/in/elcot/avgcxr/platform/payment/repository`
...
| --- | --- | --- |
| `PaymentRepository.java` | Java | Payment Repository — data-access / port (persistence or external boundary). |
