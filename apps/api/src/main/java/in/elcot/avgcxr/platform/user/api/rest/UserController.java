...
public class UserController {
    ...
    public ResponseEntity<UserResponse> create(@Valid @RequestBody CreateUserRequest req) {
        var cmd = new CreateUserCommand(req.username(), req.email(), req.mobileNumber(), req.fullName(), req.fullNameTamil(), req.password(), req.district(), req.roles());
    ...
    public ResponseEntity<UserResponse> update(@PathVariable String id, @Valid @RequestBody UpdateUserRequest req) {
        var cmd = new UpdateUserCommand(req.fullName(), req.fullNameTamil(), req.district(), req.department(), req.designation());
