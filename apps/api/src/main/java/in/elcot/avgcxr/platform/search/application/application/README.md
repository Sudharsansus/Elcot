# `apps/api/src/main/java/in/elcot/avgcxr/platform/search/application/application`
...
- [`service/`](service/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/search/application/application`).
