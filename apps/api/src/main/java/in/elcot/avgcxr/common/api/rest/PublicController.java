...
/**
 * Public-facing endpoints (no auth). Used by the public-portal frontend. All figures are sourced
 * from the live database, not hardcoded.
 */
@RestController
...
public class PublicController {
  ...
  public ResponseEntity<ApiResponse<List<Map<String, String>>>> subspecialties() {
    // AVGC-XR sub-sectors are stable reference data (seeded in V19, reference_data type
    // SUB_SECTOR).
