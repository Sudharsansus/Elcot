# `apps/api/src/main/java/in/elcot/avgcxr/platform/audit/infrastructure/persistence/entity`
...
| --- | --- | --- |
| `AuditEntity.java` | Java | Audit Entity — JPA entity (maps to a database table). |
| `AuditLogEntity.java` | Java | Audit Log Entity — JPA entity (maps to a database table). |
