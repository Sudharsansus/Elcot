# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/businessconnect/api/messaging`
...
| --- | --- | --- |
| `BusinessconnectEventConsumer.java` | Java | Businessconnect Event Consumer — Java class. |
