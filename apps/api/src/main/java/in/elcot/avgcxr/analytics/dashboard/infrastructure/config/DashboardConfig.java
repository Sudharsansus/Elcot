 ...
 *
 * <ul>
 *   <li>Cache manager for dashboard stats (60s TTL via scheduler)
 *   <li>Auto-refresh of aggregations every 5 minutes
 *   <li>Per-role dashboard settings
 * </ul>
 */
@Configuration
@EnableScheduling
public class DashboardConfig {
  ...
  @Scheduled(
      fixedDelayString = "${avgcxr.dashboard.refresh-ms:300000}",
  ...
  public static class DashboardMetrics {
    private final java.util.concurrent.atomic.AtomicLong viewsTotal =
