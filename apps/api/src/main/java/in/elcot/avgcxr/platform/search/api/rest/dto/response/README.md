# `apps/api/src/main/java/in/elcot/avgcxr/platform/search/api/rest/dto/response`
...
| --- | --- | --- |
| `SearchResponse.java` | Java | Search Response — data transfer object (API payload). |
| `SearchResultResponse.java` | Java | Search Result Response — data transfer object (API payload). |
