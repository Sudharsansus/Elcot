# `apps/api/src/main/java/in/elcot/avgcxr/support/helpdesk/domain/event`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/support/helpdesk/domain`).

## Files (3)

| File | Type | What it does |
| --- | --- | --- |
| `HelpdeskCreatedEvent.java` | Java | Helpdesk Created Event — Java class. |
| `HelpdeskTicketCreatedEvent.java` | Java | Helpdesk Ticket Created Event — Java class. |
| `HelpdeskUpdatedEvent.java` | Java | Helpdesk Updated Event — Java class. |
