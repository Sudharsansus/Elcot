# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/infrastructure/config`
...
| --- | --- | --- |
| `NotificationConfig.java` | Java | Notification Config — Spring configuration. |
