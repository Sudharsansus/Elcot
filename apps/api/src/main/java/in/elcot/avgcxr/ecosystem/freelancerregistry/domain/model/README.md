# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/freelancerregistry/domain/model`
...
| --- | --- | --- |
| `FreelancerProfile.java` | Java | Freelancer Profile — Java class. |
| `Freelancerregistry.java` | Java | Freelancerregistry — Java class. |
| `FreelancerregistryId.java` | Java | Freelancerregistry Id — Java class. |
