# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/infrastructure/persistence/adapter`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/document/infrastructure/persistence`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `DocumentRepositoryAdapter.java` | Java | Document Repository Adapter — data-access / port (persistence or external boundary). |
