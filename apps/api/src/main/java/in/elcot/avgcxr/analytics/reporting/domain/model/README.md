# `apps/api/src/main/java/in/elcot/avgcxr/analytics/reporting/domain/model`
...
| --- | --- | --- |
| `ReportData.java` | Java | Report Data — Java class. |
| `ReportingData.java` | Java | Reporting Data — Java class. |
