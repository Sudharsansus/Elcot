# `apps/api/src/main/java/in/elcot/avgcxr/common/api`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/common`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`rest/`](rest/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/common/api`).
