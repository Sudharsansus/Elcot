# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/domain/model`
...
| --- | --- | --- |
| `Document.java` | Java | Document — Java class. |
| `DocumentId.java` | Java | Document Id — Java class. |
| `DocumentStatus.java` | Java | Document Status — Java class. |
