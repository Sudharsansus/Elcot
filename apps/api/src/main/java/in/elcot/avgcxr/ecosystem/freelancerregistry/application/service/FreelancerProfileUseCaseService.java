...
@Slf4j
public class FreelancerProfileUseCaseService
    implements CreateFreelancerProfileUseCase, GetFreelancerProfileUseCase {
  ...
  public FreelancerProfileResponse getById(UUID id) {
    FreelancerProfileEntity e =
        repo.findById(id).orElseThrow(() -> new FreelancerProfileNotFoundException(id));
    return toResponse(e);
  }
