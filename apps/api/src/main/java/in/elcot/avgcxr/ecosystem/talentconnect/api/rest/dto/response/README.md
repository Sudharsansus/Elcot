# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/talentconnect/api/rest/dto/response`
...
| --- | --- | --- |
| `TalentProfileResponse.java` | Java | Talent Profile Response — data transfer object (API payload). |
| `TalentconnectResponse.java` | Java | Talentconnect Response — data transfer object (API payload). |
