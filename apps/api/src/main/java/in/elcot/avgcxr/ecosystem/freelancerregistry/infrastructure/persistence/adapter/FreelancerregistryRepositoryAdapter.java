...
public class FreelancerregistryRepositoryAdapter implements FreelancerregistryRepositoryPort {
  ...
  public FreelancerregistryRepositoryAdapter(
      JpaFreelancerregistryRepository jpaRepo, FreelancerregistryMapper mapper) {
    this.jpaRepo = jpaRepo;
    this.mapper = mapper;
  }

  @Override
  public Freelancerregistry save(Freelancerregistry entity) {
  ...
  @Override
  public void deleteById(FreelancerregistryId id) {
    jpaRepo.deleteById(id.toString());
  }

  @Override
  public boolean existsById(FreelancerregistryId id) {
