# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/api/messaging`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/api`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `NotificationEventConsumer.java` | Java | Notification Event Consumer — Java class. |
