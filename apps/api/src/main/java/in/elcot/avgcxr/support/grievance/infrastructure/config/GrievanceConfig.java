 ...
 * <p>Provides:</p>
 * <ul>
 *   <li>Acknowledgment SLA: 7 days (mandatory by DPDP)</li>
 *   <li>Resolution SLA: 30 days (mandatory by DPDP)</li>
 *   <li>Escalation scheduler that runs daily</li>
 * </ul>
 */
@Configuration
@EnableScheduling
public class GrievanceConfig {
    ...
    public GrievanceSla grievanceSla() {
        return new GrievanceSla(
                Duration.ofDays(acknowledgmentDays),
                Duration.ofDays(resolutionDays)
        );
    }
    ...
    public static class GrievanceMetrics {
        private final java.util.concurrent.atomic.AtomicInteger filed = new java.util.concurrent.atomic.AtomicInteger();
        private final java.util.concurrent.atomic.AtomicInteger resolved = new java.util.concurrent.atomic.AtomicInteger();
        private final java.util.concurrent.atomic.AtomicInteger escalated = new java.util.concurrent.atomic.AtomicInteger();

        public void incrementFiled() { filed.incrementAndGet(); }
        public void incrementResolved() { resolved.incrementAndGet(); }
        public void incrementEscalated() { escalated.incrementAndGet(); }
        public int getFiled() { return filed.get(); }
