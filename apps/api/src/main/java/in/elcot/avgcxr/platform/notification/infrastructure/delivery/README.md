# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/infrastructure/delivery`
...
| --- | --- | --- |
| `EmailDeliveryProvider.java` | Java | Email Delivery Provider — provider component. |
| `SmsDeliveryProvider.java` | Java | Sms Delivery Provider — provider component. |
