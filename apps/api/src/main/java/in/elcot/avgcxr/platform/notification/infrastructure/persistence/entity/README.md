# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/infrastructure/persistence/entity`
...
| --- | --- | --- |
| `NotificationEntity.java` | Java | Notification Entity — JPA entity (maps to a database table). |
