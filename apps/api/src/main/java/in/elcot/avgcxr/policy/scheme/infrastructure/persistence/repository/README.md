# `apps/api/src/main/java/in/elcot/avgcxr/policy/scheme/infrastructure/persistence/repository`
...
| --- | --- | --- |
| `JpaSchemeRepository.java` | Java | Jpa Scheme Repository — data-access / port (persistence or external boundary). |
