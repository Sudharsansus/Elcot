# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/application/application/service`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/application/application`).
