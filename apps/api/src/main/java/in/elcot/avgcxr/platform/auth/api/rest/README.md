# `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/api/rest`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/api`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `AuthController.java` | Java | Auth Controller — REST controller (defines HTTP endpoints). |

## Subfolders (1)

- [`dto/`](dto/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/api/rest`).
