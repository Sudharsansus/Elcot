# `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/api/rest/dto/response`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `AuthResponse.java` | Java | Auth Response — data transfer object (API payload). |
