# `apps/api/src/main/java/in/elcot/avgcxr/support/helpdesk/infrastructure/persistence/entity`
...
| --- | --- | --- |
| `HelpdeskEntity.java` | Java | Helpdesk Entity — JPA entity (maps to a database table). |
| `HelpdeskTicketEntity.java` | Java | Helpdesk Ticket Entity — JPA entity (maps to a database table). |
