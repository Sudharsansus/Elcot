# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/infrastructure/persistence/repository`
...
| --- | --- | --- |
| `JpaNotificationRepository.java` | Java | Jpa Notification Repository — data-access / port (persistence or external boundary). |
