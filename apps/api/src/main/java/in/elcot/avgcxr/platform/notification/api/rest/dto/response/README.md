# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/api/rest/dto/response`
...
| --- | --- | --- |
| `NotificationResponse.java` | Java | Notification Response — data transfer object (API payload). |
