# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/talentconnect/infrastructure/config`
...
| --- | --- | --- |
| `TalentconnectConfig.java` | Java | Talentconnect Config — Spring configuration. |
