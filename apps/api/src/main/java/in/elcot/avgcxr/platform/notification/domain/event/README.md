# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/domain/event`
...
| --- | --- | --- |
| `NotificationCreatedEvent.java` | Java | Notification Created Event — Java class. |
| `NotificationUpdatedEvent.java` | Java | Notification Updated Event — Java class. |
