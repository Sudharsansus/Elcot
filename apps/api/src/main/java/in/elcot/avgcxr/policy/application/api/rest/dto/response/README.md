# `apps/api/src/main/java/in/elcot/avgcxr/policy/application/api/rest/dto/response`
...
| --- | --- | --- |
| `ApplicationResponse.java` | Java | Application Response — data transfer object (API payload). |
