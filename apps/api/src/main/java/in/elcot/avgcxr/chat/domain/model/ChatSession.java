...
/**
 * Pure domain representation of a chat session (a thread of messages
 * for one user, or anonymous via session_token).
 *
 * <p>Mutable for incremental updates (title, language, messageCount).
 * Hexagonal: no framework imports.</p>
 */
@Getter
@Setter
