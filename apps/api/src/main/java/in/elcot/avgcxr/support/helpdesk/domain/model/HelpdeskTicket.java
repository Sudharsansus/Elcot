...
/**
 * Domain aggregate root for Helpdesk ticket management with priority-based routing, SLA tracking,
 * and resolution workflow. This class contains business logic and validation rules. It has NO
