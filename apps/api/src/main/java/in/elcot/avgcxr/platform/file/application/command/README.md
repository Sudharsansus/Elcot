# `apps/api/src/main/java/in/elcot/avgcxr/platform/file/application/command`
...
| --- | --- | --- |
| `CreateFileCommand.java` | Java | Create File Command — Java class. |
| `CreateFileMetadataCommand.java` | Java | Create File Metadata Command — Java class. |
| `UpdateFileCommand.java` | Java | Update File Command — Java class. |
