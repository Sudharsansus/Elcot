 ...
 *
 * <ul>
 *   <li>Max file size (default 25 MB)
 *   <li>Allowed MIME types (PDF, images, video)
 *   <li>MinIO bucket name and CDN base URL
 * </ul>
 */
@Configuration
public class FileConfig {
  ...
  @Value(
      "${avgcxr.file.allowed-mime-types:application/pdf,image/jpeg,image/png,image/webp,video/mp4,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document}")
