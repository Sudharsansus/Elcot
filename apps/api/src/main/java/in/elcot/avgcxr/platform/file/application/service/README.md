# `apps/api/src/main/java/in/elcot/avgcxr/platform/file/application/service`
...
| --- | --- | --- |
| `FileMetadataUseCaseService.java` | Java | File Metadata Use Case Service — service (business logic). |
| `FileService.java` | Java | File Service — service (business logic). |
