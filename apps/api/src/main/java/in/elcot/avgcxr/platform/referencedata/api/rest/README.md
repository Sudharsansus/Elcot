# `apps/api/src/main/java/in/elcot/avgcxr/platform/referencedata/api/rest`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/referencedata/api`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `ReferenceDataController.java` | Java | Reference Data Controller — REST controller (defines HTTP endpoints). |
