# `apps/api/src/main/java/in/elcot/avgcxr/analytics/chatbot/application`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics/chatbot`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`service/`](service/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics/chatbot/application`).
