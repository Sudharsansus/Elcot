 ...
 * <p>Provides:</p>
 * <ul>
 *   <li>Password policy (min length, complexity, rotation)</li>
 *   <li>Account lockout policy (5 attempts, 15 min lockout — DPDP best practice)</li>
 *   <li>Email verification TTL</li>
 * </ul>
 */
@Configuration
