# `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `GrievanceMapper.java` | Java | Grievance Mapper — mapper (entity ↔ DTO conversion). |
