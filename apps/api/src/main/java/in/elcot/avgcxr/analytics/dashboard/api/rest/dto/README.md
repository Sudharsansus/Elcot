# `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/api/rest/dto`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/api/rest`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`response/`](response/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/api/rest/dto`).
