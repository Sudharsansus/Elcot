...
@Tag(
    name = "Schemes",
    description =
        "AVGC-XR scheme catalogue and lifecycle — list/view (public) and create/publish/close (admin)")
@RestController
...
public class SchemeController {
  ...
  @Operation(
      ...
      description = "Returns a single scheme by its UUID. Public endpoint.")
  @GetMapping("/{id}")
  ...
  @Operation(
      summary = "Publish scheme",
      description = "Transitions a DRAFT scheme to PUBLISHED. Requires ROLE_ADMIN.")
  ...
  @Operation(
      summary = "Close scheme",
      description = "Transitions a PUBLISHED scheme to CLOSED. Requires ROLE_ADMIN.")
