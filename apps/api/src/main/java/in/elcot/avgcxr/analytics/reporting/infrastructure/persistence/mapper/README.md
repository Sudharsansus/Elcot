# `apps/api/src/main/java/in/elcot/avgcxr/analytics/reporting/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `ReportDataMapper.java` | Java | Report Data Mapper — mapper (entity ↔ DTO conversion). |
