# `apps/api/src/main/java/in/elcot/avgcxr/chat/api`
...
- [`rest/`](rest/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat/api`).
