# `apps/api/src/main/java/in/elcot/avgcxr/policy/workflow/api/rest/dto/response`
...
| --- | --- | --- |
| `WorkflowInstanceResponse.java` | Java | Workflow Instance Response — data transfer object (API payload). |
| `WorkflowResponse.java` | Java | Workflow Response — data transfer object (API payload). |
