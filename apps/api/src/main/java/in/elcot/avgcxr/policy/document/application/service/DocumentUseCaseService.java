...
/**
 * Real implementation: persists document metadata to PostgreSQL. File content goes to MinIO (or
 * filesystem fallback) - tracked via storageKey.
 */
@Service
...
public class DocumentUseCaseService
  ...
  public DocumentResponse getById(UUID id) {
    DocumentEntity e = docRepo.findById(id).orElseThrow(() -> new DocumentNotFoundException(id));
    return toResponse(e);
  }
