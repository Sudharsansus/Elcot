# `apps/api/src/main/java/in/elcot/avgcxr/policy/workflow/application/service`
...
| --- | --- | --- |
| `WorkflowInstanceUseCaseService.java` | Java | Workflow Instance Use Case Service — service (business logic). |
| `WorkflowService.java` | Java | Workflow Service — service (business logic). |
