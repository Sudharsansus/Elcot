# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/businessconnect/infrastructure/config`
...
| --- | --- | --- |
| `BusinessconnectConfig.java` | Java | Businessconnect Config — Spring configuration. |
