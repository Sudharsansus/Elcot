# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/freelancerregistry/infrastructure/config`
...
| --- | --- | --- |
| `FreelancerregistryConfig.java` | Java | Freelancerregistry Config — Spring configuration. |
