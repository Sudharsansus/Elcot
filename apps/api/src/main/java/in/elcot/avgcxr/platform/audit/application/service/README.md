# `apps/api/src/main/java/in/elcot/avgcxr/platform/audit/application/service`
...
| --- | --- | --- |
| `AuditLogUseCaseService.java` | Java | Audit Log Use Case Service — service (business logic). |
| `AuditService.java` | Java | Audit Service — service (business logic). |
