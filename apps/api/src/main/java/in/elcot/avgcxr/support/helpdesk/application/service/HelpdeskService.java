...
import in.elcot.avgcxr.support.helpdesk.domain.exception.DuplicateHelpdeskException;
...
public class HelpdeskService implements CreateHelpdeskUseCase, GetHelpdeskUseCase {
    ...
    public HelpdeskService(HelpdeskRepositoryPort repository) { this.repository = repository; }
    ...
    @Override
    public Optional<Helpdesk> findById(HelpdeskId id) { return repository.findById(id); }
    ...
    @Transactional
    public void delete(HelpdeskId id) { repository.deleteById(id); }
}
