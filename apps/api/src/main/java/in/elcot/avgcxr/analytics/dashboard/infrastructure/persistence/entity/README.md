# `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/infrastructure/persistence/entity`
...
| --- | --- | --- |
| `DashboardDataEntity.java` | Java | Dashboard Data Entity — JPA entity (maps to a database table). |
