# `apps/api/src/main/java/in/elcot/avgcxr/policy/application/application/service`
...
| --- | --- | --- |
| `ApplicationUseCaseService.java` | Java | Application Use Case Service — service (business logic). |
