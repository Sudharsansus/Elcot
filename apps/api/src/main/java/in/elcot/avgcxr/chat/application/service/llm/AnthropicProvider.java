 ...
 *
 * <p>Activated when {@code avgcxr.llm.provider=anthropic} AND
 * {@code avgcxr.llm.anthropic.api-key} is set.</p>
 *
 * <p>Default model: claude-3-5-haiku-latest (cheap, fast, 200K context).
 * Override with {@code avgcxr.llm.anthropic.model}.</p>
 */
@Service
...
public class AnthropicProvider implements LlmProvider {
    ...
    public LlmResponse complete(String systemPrompt, List<Map<String, String>> messages, LlmOptions options) {
        ...
        try {
            ...
            return LlmResponse.of(content.toString(), useModel, in, out, System.currentTimeMillis() - start);
        } catch (Exception e) {
