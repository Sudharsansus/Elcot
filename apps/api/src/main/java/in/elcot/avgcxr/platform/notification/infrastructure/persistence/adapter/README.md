# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/infrastructure/persistence/adapter`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/infrastructure/persistence`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `NotificationRepositoryAdapter.java` | Java | Notification Repository Adapter — data-access / port (persistence or external boundary). |
