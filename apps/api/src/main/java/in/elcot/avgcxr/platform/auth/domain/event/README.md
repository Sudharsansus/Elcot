# `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/domain/event`
...
| --- | --- | --- |
| `AuthCreatedEvent.java` | Java | Auth Created Event — Java class. |
| `AuthUpdatedEvent.java` | Java | Auth Updated Event — Java class. |
