# `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/api/rest/dto/response`
...
| --- | --- | --- |
| `GrievanceResponse.java` | Java | Grievance Response — data transfer object (API payload). |
