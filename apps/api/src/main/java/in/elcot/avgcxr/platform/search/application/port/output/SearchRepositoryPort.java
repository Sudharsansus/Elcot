...
/**
 * Output port for Search persistence + retrieval. Implemented by
 * infrastructure adapter that talks to Elasticsearch.
 */
public interface SearchRepositoryPort {
    ...
    /**
     * RAG-friendly full-text search across scheme/company/talent/freelancer documents.
     * Returns up to {@code limit} matching documents.
     *
     * <p>If Elasticsearch is unavailable, implementations may return an empty list.</p>
     */
