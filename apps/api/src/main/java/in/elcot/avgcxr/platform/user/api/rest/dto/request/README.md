# `apps/api/src/main/java/in/elcot/avgcxr/platform/user/api/rest/dto/request`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/user/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `CreateUserRequest.java` | Java | Create User Request — data transfer object (API payload). |
| `UpdateUserRequest.java` | Java | Update User Request — data transfer object (API payload). |
