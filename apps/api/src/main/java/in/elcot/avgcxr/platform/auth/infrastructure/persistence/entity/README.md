# `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/infrastructure/persistence/entity`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/infrastructure/persistence`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `AuthEntity.java` | Java | Auth Entity — JPA entity (maps to a database table). |
| `AuthUserEntity.java` | Java | Auth User Entity — JPA entity (maps to a database table). |
