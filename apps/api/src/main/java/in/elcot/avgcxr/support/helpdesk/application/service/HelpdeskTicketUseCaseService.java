 ...
 *
 * <p>HEXAGONAL FIX (HIGH-001 audit): Application layer depends ONLY on the output port
...
@Slf4j
public class HelpdeskTicketUseCaseService implements CreateHelpdeskTicketUseCase, GetHelpdeskTicketUseCase {
    ...
    public HelpdeskTicketResponse getById(UUID id) {
        HelpdeskTicket ticket = repo.findById(id)
                .orElseThrow(() -> new HelpdeskTicketNotFoundException(id));
