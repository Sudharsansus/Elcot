# `apps/api/src/main/java/in/elcot/avgcxr/platform/audit/domain/model`
...
| --- | --- | --- |
| `Audit.java` | Java | Audit — Java class. |
| `AuditId.java` | Java | Audit Id — Java class. |
| `AuditLog.java` | Java | Audit Log — Java class. |
