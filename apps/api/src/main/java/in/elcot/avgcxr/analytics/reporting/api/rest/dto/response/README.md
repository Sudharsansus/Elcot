# `apps/api/src/main/java/in/elcot/avgcxr/analytics/reporting/api/rest/dto/response`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics/reporting/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `ReportDataResponse.java` | Java | Report Data Response — data transfer object (API payload). |
| `ReportingResponse.java` | Java | Reporting Response — data transfer object (API payload). |
