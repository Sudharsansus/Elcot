# `apps/api/src/main/java/in/elcot/avgcxr/platform/referencedata/infrastructure`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/referencedata`).

_No files directly in this folder (see subfolders below)._

## Subfolders (1)

- [`persistence/`](persistence/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/referencedata/infrastructure`).
