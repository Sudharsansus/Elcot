# `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/infrastructure/persistence/repository`
...
| --- | --- | --- |
| `JpaGrievanceRepository.java` | Java | Jpa Grievance Repository — data-access / port (persistence or external boundary). |
