# `apps/api/src/main/java/in/elcot/avgcxr/platform/audit/api/rest/dto/response`
...
| --- | --- | --- |
| `AuditLogResponse.java` | Java | Audit Log Response — data transfer object (API payload). |
| `AuditResponse.java` | Java | Audit Response — data transfer object (API payload). |
