...
public class Application extends AuditableEntity {
 ...
 DRAFT, SUBMITTED, UNDER_REVIEW, APPROVED, REJECTED, WITHDRAWN, FUND_DISBURSED;
 ...
 public static Application createDraft(UUID schemeId, UUID applicantId, String district, String appNumber) {
