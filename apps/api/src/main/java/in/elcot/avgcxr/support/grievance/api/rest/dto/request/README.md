# `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/api/rest/dto/request`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/api/rest/dto`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `CreateGrievanceRequest.java` | Java | Create Grievance Request — data transfer object (API payload). |
