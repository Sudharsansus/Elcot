# `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/api/rest/dto/response`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `DashboardDataResponse.java` | Java | Dashboard Data Response — data transfer object (API payload). |
| `DashboardResponse.java` | Java | Dashboard Response — data transfer object (API payload). |
