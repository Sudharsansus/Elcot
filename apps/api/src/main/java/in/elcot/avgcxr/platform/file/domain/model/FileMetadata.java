...
/**
 * Domain aggregate root for File upload, download, and management via MinIO S3-compatible storage
 * with presigned URLs. This class contains business logic and validation rules. It has NO
