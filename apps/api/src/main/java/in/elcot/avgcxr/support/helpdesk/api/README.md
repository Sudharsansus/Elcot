# `apps/api/src/main/java/in/elcot/avgcxr/support/helpdesk/api`
...
- [`messaging/`](messaging/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/support/helpdesk/api`).
- [`rest/`](rest/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/support/helpdesk/api`).
