 ...
 *
 * <p>Pulls relevant documents for the user's query from:</p>
 * <ol>
 *   <li><b>Elasticsearch</b> (when configured) -- full-text, semantic, bilingual</li>
 *   <li><b>PostgreSQL ILIKE fallback</b> -- searches schemes + help content</li>
 * </ol>
 *
 * <p>Returns the top-K documents to be inlined in the LLM system prompt.</p>
 */
@Service
public class RagService {
    ...
    public RagService(ObjectProvider<ElasticsearchClientWrapper> esProvider,
    ...
    public List<RagDocument> retrieve(String userQuery, String language) {
        ...
        if (es != null) {
            try {
                SearchResult<?> r = es.search(
                        "avgcxr-general",
                        (Class<?>) Map.class,
                        userQuery, 0, DEFAULT_TOP_K);
