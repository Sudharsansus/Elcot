# `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/infrastructure/persistence/adapter`
...
| --- | --- | --- |
| `AuthRepositoryAdapter.java` | Java | Auth Repository Adapter — data-access / port (persistence or external boundary). |
