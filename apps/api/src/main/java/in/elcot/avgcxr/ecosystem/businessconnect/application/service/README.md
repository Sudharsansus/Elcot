# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/businessconnect/application/service`
...
| --- | --- | --- |
| `BusinessconnectService.java` | Java | Businessconnect Service — service (business logic). |
| `CompanyUseCaseService.java` | Java | Company Use Case Service — service (business logic). |
