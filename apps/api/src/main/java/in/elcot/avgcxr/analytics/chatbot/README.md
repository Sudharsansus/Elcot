# `apps/api/src/main/java/in/elcot/avgcxr/analytics/chatbot`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics`).

_No files directly in this folder (see subfolders below)._

## Subfolders (2)

- [`api/`](api/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics/chatbot`).
- [`application/`](application/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics/chatbot`).
