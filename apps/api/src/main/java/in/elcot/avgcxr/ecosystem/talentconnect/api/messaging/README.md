# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/talentconnect/api/messaging`
...
| --- | --- | --- |
| `TalentconnectEventConsumer.java` | Java | Talentconnect Event Consumer — Java class. |
