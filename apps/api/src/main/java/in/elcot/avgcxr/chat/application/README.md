# `apps/api/src/main/java/in/elcot/avgcxr/chat/application`
...
- [`port/`](port/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat/application`).
- [`service/`](service/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat/application`).
