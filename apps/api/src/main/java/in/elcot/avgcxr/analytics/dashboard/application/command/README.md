# `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/application/command`
...
| --- | --- | --- |
| `CreateDashboardDataCommand.java` | Java | Create Dashboard Data Command — Java class. |
