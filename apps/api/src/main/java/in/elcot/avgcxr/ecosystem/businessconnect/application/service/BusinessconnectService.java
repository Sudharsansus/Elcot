...
public class BusinessconnectService
    implements CreateBusinessconnectUseCase, GetBusinessconnectUseCase {

  private final BusinessconnectRepositoryPort repository;

  public BusinessconnectService(BusinessconnectRepositoryPort repository) {
  ...
  @Override
  public Optional<Businessconnect> findById(BusinessconnectId id) {
  ...
  public Businessconnect getById(BusinessconnectId id) {
    return repository
        .findById(id)
        .orElseThrow(() -> new BusinessconnectNotFoundException(id.value()));
  }
  ...
  @Transactional
  public void delete(BusinessconnectId id) {
