...
public class AuthEventConsumer {
  ...
  public void onAuthCreated(AuthCreatedEvent e) {
    log.info("Auth: userId={}, action={}", e.userId(), e.action());
  }

  @RabbitListener(queues = "avgc.auth.updated")
  public void onAuthUpdated(AuthUpdatedEvent e) {
    log.info("Auth updated: userId={}, action={}", e.userId(), e.action());
  }
}
