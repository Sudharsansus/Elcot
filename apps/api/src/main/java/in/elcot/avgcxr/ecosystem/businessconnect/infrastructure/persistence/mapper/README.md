# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/businessconnect/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `BusinessconnectMapper.java` | Java | Businessconnect Mapper — mapper (entity ↔ DTO conversion). |
| `CompanyMapper.java` | Java | Company Mapper — mapper (entity ↔ DTO conversion). |
