# `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/domain/exception`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/domain`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `AuthNotFoundException.java` | Java | Auth Not Found Exception — exception type. |
| `DuplicateAuthException.java` | Java | Duplicate Auth Exception — exception type. |
