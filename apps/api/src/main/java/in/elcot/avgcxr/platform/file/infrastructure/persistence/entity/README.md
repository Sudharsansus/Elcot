# `apps/api/src/main/java/in/elcot/avgcxr/platform/file/infrastructure/persistence/entity`
...
| --- | --- | --- |
| `FileEntity.java` | Java | File Entity — JPA entity (maps to a database table). |
| `FileMetadataEntity.java` | Java | File Metadata Entity — JPA entity (maps to a database table). |
