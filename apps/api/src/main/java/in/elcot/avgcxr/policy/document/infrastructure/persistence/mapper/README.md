# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `DocumentMapper.java` | Java | Document Mapper — mapper (entity ↔ DTO conversion). |
