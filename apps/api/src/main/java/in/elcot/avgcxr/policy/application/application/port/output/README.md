# `apps/api/src/main/java/in/elcot/avgcxr/policy/application/application/port/output`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/application/application/port`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `ApplicationRepositoryPort.java` | Java | Application Repository Port — data-access / port (persistence or external boundary). |
