# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/application/service`
...
| --- | --- | --- |
| `DocumentUseCaseService.java` | Java | Document Use Case Service — service (business logic). |
