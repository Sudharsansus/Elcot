# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/infrastructure/persistence/entity`
...
| --- | --- | --- |
| `DocumentEntity.java` | Java | Document Entity — JPA entity (maps to a database table). |
