# `apps/api/src/main/java/in/elcot/avgcxr/platform/user/api/rest/dto/response`
...
| --- | --- | --- |
| `UserProfileResponse.java` | Java | User Profile Response — data transfer object (API payload). |
| `UserResponse.java` | Java | User Response — data transfer object (API payload). |
