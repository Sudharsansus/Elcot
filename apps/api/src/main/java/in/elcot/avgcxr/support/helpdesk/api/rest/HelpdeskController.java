...
public class HelpdeskController {
  ...
  @PostMapping
  public ResponseEntity<HelpdeskResponse> create(
      @Valid @RequestBody CreateHelpdeskRequest request) {
    Helpdesk entity =
        service.create(new CreateHelpdeskCommand(request.name(), request.description(), "system"));
  ...
  @PutMapping("/{id}")
  public ResponseEntity<HelpdeskResponse> update(
      @PathVariable String id, @Valid @RequestBody UpdateHelpdeskRequest request) {
    Helpdesk entity =
        service.update(
            HelpdeskId.of(id), new UpdateHelpdeskCommand(request.name(), request.description()));
