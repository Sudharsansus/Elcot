# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/application/port/output`
...
| --- | --- | --- |
| `DocumentRepositoryPort.java` | Java | Document Repository Port — data-access / port (persistence or external boundary). |
