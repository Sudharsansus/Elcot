...
public record BusinessconnectUpdatedEvent(
    UUID businessconnectId, String field, String oldValue, String newValue, Instant occurredAt) {
  public static BusinessconnectUpdatedEvent from(
