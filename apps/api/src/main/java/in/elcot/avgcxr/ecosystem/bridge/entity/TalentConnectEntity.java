...
/**
 * AVGC-XR Bridge — Talent Connect directory entry. Maps to the V6 {@code talent_connect} table
 * (previously no JPA entity). {@code skills} is a native Postgres {@code text[]}; personal contact
 * PII (email, mobile) is encrypted at rest (§IV.8).
 */
@Entity
@Table(name = "talent_connect")
@Getter
@Setter
public class TalentConnectEntity {
