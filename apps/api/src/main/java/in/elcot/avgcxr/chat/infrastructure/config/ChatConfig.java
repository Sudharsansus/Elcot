 ...
 *
 * <p>LLM provider selection (in priority order, first available wins):</p>
 * <ol>
 *   <li>{@code avgcxr.llm.provider=openai} -- needs {@code avgcxr.llm.openai.api-key}</li>
 *   <li>{@code avgcxr.llm.provider=anthropic} -- needs {@code avgcxr.llm.anthropic.api-key}</li>
 *   <li>{@code avgcxr.llm.provider=ollama} -- needs Ollama running locally</li>
 *   <li>unset or {@code rule-based} -- fallback (always available)</li>
 * </ol>
 */
@Configuration
@EnableScheduling
