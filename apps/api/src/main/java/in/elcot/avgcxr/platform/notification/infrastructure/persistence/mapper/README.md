# `apps/api/src/main/java/in/elcot/avgcxr/platform/notification/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `NotificationMapper.java` | Java | Notification Mapper — mapper (entity ↔ DTO conversion). |
