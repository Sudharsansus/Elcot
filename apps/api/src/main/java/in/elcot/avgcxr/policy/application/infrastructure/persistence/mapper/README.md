# `apps/api/src/main/java/in/elcot/avgcxr/policy/application/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `ApplicationMapper.java` | Java | Application Mapper — mapper (entity ↔ DTO conversion). |
