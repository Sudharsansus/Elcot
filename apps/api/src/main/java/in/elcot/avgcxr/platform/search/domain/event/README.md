# `apps/api/src/main/java/in/elcot/avgcxr/platform/search/domain/event`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/search/domain`).

## Files (3)

| File | Type | What it does |
| --- | --- | --- |
| `SearchCreatedEvent.java` | Java | Search Created Event — Java class. |
| `SearchResultCreatedEvent.java` | Java | Search Result Created Event — Java class. |
| `SearchUpdatedEvent.java` | Java | Search Updated Event — Java class. |
