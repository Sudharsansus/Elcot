# `apps/api/src/main/java/in/elcot/avgcxr/platform/search/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `SearchMapper.java` | Java | Search Mapper — mapper (entity ↔ DTO conversion). |
| `SearchResultMapper.java` | Java | Search Result Mapper — mapper (entity ↔ DTO conversion). |
