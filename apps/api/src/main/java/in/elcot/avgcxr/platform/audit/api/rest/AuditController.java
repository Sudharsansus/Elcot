...
public class AuditController {
  ...
  public ResponseEntity<AuditResponse> create(@Valid @RequestBody CreateAuditRequest request) {
    Audit entity =
        service.create(new CreateAuditCommand(request.name(), request.description(), "system"));
  ...
  public ResponseEntity<AuditResponse> update(
      @PathVariable String id, @Valid @RequestBody UpdateAuditRequest request) {
    Audit entity =
        service.update(
            AuditId.of(id), new UpdateAuditCommand(request.name(), request.description()));
