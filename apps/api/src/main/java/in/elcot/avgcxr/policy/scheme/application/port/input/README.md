# `apps/api/src/main/java/in/elcot/avgcxr/policy/scheme/application/port/input`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/scheme/application/port`).

## Files (3)

| File | Type | What it does |
| --- | --- | --- |
| `CreateSchemeUseCase.java` | Java | Create Scheme Use Case — Java class. |
| `GetSchemeUseCase.java` | Java | Get Scheme Use Case — Java class. |
| `ProcessSchemeUseCase.java` | Java | Process Scheme Use Case — Java class. |
