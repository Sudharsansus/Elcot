...
public class SearchRepositoryAdapter implements SearchRepositoryPort {
    ...
    /**
     * RAG-friendly full-text search. Returns up to {@code limit} matching
     * Search rows from the SQL store (PostgreSQL ILIKE fallback when
    ...
    public List<Search> fullTextSearch(String query, int limit) {
        ...
        var entities = jpaRepo.fullTextSearch("%" + query + "%",
