# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/infrastructure/persistence/repository`
...
| --- | --- | --- |
| `JpaDocumentRepository.java` | Java | Jpa Document Repository — data-access / port (persistence or external boundary). |
