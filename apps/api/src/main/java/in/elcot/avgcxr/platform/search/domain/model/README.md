# `apps/api/src/main/java/in/elcot/avgcxr/platform/search/domain/model`
...
| --- | --- | --- |
| `Search.java` | Java | Search — Java class. |
| `SearchId.java` | Java | Search Id — Java class. |
| `SearchResult.java` | Java | Search Result — Java class. |
