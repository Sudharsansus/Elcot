# `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/domain/model`
...
| --- | --- | --- |
| `Grievance.java` | Java | Grievance — Java class. |
| `GrievanceId.java` | Java | Grievance Id — Java class. |
