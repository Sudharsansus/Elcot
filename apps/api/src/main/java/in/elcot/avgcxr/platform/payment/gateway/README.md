# `apps/api/src/main/java/in/elcot/avgcxr/platform/payment/gateway`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/payment`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `PaymentGateway.java` | Java | Payment Gateway — Java class. |
| `RazorpayPaymentGateway.java` | Java | Razorpay Payment Gateway — Java class. |
