# `apps/api/src/main/java/in/elcot/avgcxr/chat/domain/model`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/chat/domain`).

## Files (3)

| File | Type | What it does |
| --- | --- | --- |
| `ChatMessage.java` | Java | Chat Message — Java class. |
| `ChatRole.java` | Java | Chat Role — Java class. |
| `ChatSession.java` | Java | Chat Session — Java class. |
