# `apps/api/src/main/java/in/elcot/avgcxr/support/helpdesk/api/rest/dto/response`
...
| --- | --- | --- |
| `HelpdeskResponse.java` | Java | Helpdesk Response — data transfer object (API payload). |
| `HelpdeskTicketResponse.java` | Java | Helpdesk Ticket Response — data transfer object (API payload). |
