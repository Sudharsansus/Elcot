 ...
 *
 * <p>Audit fix: the {@link StrapiClient} was previously declared but
 * never invoked. These endpoints exercise it for the public portal:
 * scheme descriptions, FAQs, news, and announcements.</p>
 */
@RestController
...
public class CmsController {
    ...
    @GetMapping("/faqs")
    public ResponseEntity<List<Object>> getFaqs(
