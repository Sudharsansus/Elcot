 ...
 *
 * <p>Used by /api/v1/reports/export, /api/v1/applications/export, etc.</p>
 */
@Service
public class ExportService {

    /**
     * Build an XLSX workbook from a list of row maps. The first row is treated
     * as the header (column names from the keys of the first map).
     */
