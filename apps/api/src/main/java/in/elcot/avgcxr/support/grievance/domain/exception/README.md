# `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/domain/exception`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/domain`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `GrievanceAlreadyExistsException.java` | Java | Grievance Already Exists Exception — exception type. |
| `GrievanceNotFoundException.java` | Java | Grievance Not Found Exception — exception type. |
