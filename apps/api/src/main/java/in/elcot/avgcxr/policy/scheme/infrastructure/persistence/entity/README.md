# `apps/api/src/main/java/in/elcot/avgcxr/policy/scheme/infrastructure/persistence/entity`
...
| --- | --- | --- |
| `SchemeEntity.java` | Java | Scheme Entity — JPA entity (maps to a database table). |
