# `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/application/service`
...
| --- | --- | --- |
| `DashboardDataUseCaseService.java` | Java | Dashboard Data Use Case Service — service (business logic). |
| `DashboardService.java` | Java | Dashboard Service — service (business logic). |
