# `apps/api/src/main/java/in/elcot/avgcxr/analytics/reporting/domain/exception`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics/reporting/domain`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `ReportDataAlreadyExistsException.java` | Java | Report Data Already Exists Exception — exception type. |
| `ReportDataNotFoundException.java` | Java | Report Data Not Found Exception — exception type. |
