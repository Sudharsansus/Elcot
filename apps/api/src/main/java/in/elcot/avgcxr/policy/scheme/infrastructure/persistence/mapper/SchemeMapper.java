...
public final class SchemeMapper {
  ...
  public static Scheme toDomain(SchemeEntity e) {
    ...
    return Scheme.builder()
        .id(e.getId())
        .name(e.getName())
        .tamilName(e.getNameTa())
        .description(e.getDescription())
        .descriptionTa(e.getDescriptionTa())
        .category(Scheme.SchemeCategory.valueOf(e.getCategory()))
        .subCategory(e.getSubCategory())
        .ministry(e.getMinistry())
        .department(e.getDepartment())
        .fundingAmountMin(e.getFundingAmountMin())
        .fundingAmountMax(e.getFundingAmountMax())
        .fundingType(
            e.getFundingType() != null ? Scheme.FundingType.valueOf(e.getFundingType()) : null)
  ...
  public static SchemeEntity toEntity(Scheme d) {
    ...
    e.setId(d.getId());
    e.setName(d.getName());
    e.setNameTa(d.getTamilName());
    e.setDescription(d.getDescription());
    e.setDescriptionTa(d.getDescriptionTa());
    e.setCategory(d.getCategory().name());
    e.setSubCategory(d.getSubCategory());
    e.setMinistry(d.getMinistry());
    e.setDepartment(d.getDepartment());
    e.setFundingAmountMin(d.getFundingAmountMin());
    e.setFundingAmountMax(d.getFundingAmountMax());
