 ...
 * <p>Provides:</p>
 * <ul>
 *   <li>Scheme lifecycle TTLs (DRAFT, PUBLISHED, RETIRED)</li>
 *   <li>Auto-close expired schemes scheduler (daily 02:30 IST)</li>
 *   <li>Subsidy computation defaults</li>
 * </ul>
 */
@Configuration
@EnableScheduling
public class SchemeConfig {
    ...
    public SchemeLifecycles schemeLifecycles() {
        return new SchemeLifecycles(
                ...
                Duration.ofDays(archiveAfterRetirementDays)
        );
    }
    ...
    @Scheduled(cron = "${avgcxr.scheme.auto-close-cron:0 30 2 * * *}",
