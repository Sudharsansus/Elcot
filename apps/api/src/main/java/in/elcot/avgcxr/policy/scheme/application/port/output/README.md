# `apps/api/src/main/java/in/elcot/avgcxr/policy/scheme/application/port/output`
...
| --- | --- | --- |
| `SchemeRepositoryPort.java` | Java | Scheme Repository Port — data-access / port (persistence or external boundary). |
