# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/api/rest`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/document/api`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `DocumentController.java` | Java | Document Controller — REST controller (defines HTTP endpoints). |

## Subfolders (1)

- [`dto/`](dto/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/document/api/rest`).
