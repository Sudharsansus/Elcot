# `apps/api/src/main/java/in/elcot/avgcxr/platform/search/infrastructure/persistence/entity`
...
| --- | --- | --- |
| `SearchEntity.java` | Java | Search Entity — JPA entity (maps to a database table). |
| `SearchResultEntity.java` | Java | Search Result Entity — JPA entity (maps to a database table). |
