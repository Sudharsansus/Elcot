...
import in.elcot.avgcxr.policy.workflow.domain.exception.DuplicateWorkflowException;
...
public class WorkflowService implements CreateWorkflowUseCase, GetWorkflowUseCase {
    ...
    public WorkflowService(WorkflowRepositoryPort repository) { this.repository = repository; }
    ...
    @Override
    public Optional<Workflow> findById(WorkflowId id) { return repository.findById(id); }
    ...
    @Transactional
    public void delete(WorkflowId id) { repository.deleteById(id); }
}
