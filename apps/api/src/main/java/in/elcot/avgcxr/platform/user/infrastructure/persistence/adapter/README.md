# `apps/api/src/main/java/in/elcot/avgcxr/platform/user/infrastructure/persistence/adapter`
...
| --- | --- | --- |
| `UserConsentPersistenceAdapter.java` | Java | User Consent Persistence Adapter — data-access / port (persistence or external boundary). |
| `UserProfileRepositoryAdapter.java` | Java | User Profile Repository Adapter — data-access / port (persistence or external boundary). |
| `UserRepositoryAdapter.java` | Java | User Repository Adapter — data-access / port (persistence or external boundary). |
