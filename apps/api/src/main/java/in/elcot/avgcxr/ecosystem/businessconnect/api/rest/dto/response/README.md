# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/businessconnect/api/rest/dto/response`
...
| --- | --- | --- |
| `BusinessconnectResponse.java` | Java | Businessconnect Response — data transfer object (API payload). |
| `CompanyResponse.java` | Java | Company Response — data transfer object (API payload). |
