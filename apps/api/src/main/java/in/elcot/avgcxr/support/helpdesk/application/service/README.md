# `apps/api/src/main/java/in/elcot/avgcxr/support/helpdesk/application/service`
...
| --- | --- | --- |
| `HelpdeskService.java` | Java | Helpdesk Service — service (business logic). |
| `HelpdeskTicketUseCaseService.java` | Java | Helpdesk Ticket Use Case Service — service (business logic). |
