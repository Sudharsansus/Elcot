# `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/application/port/input`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/application/port`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `CreateGrievanceUseCase.java` | Java | Create Grievance Use Case — Java class. |
| `GetGrievanceUseCase.java` | Java | Get Grievance Use Case — Java class. |
