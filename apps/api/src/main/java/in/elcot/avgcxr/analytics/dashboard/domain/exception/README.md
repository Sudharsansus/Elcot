# `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/domain/exception`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/domain`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `DashboardDataAlreadyExistsException.java` | Java | Dashboard Data Already Exists Exception — exception type. |
| `DashboardDataNotFoundException.java` | Java | Dashboard Data Not Found Exception — exception type. |
