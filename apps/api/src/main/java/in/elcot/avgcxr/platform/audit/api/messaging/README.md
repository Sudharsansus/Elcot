# `apps/api/src/main/java/in/elcot/avgcxr/platform/audit/api/messaging`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/audit/api`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `AuditEventConsumer.java` | Java | Audit Event Consumer — Java class. |
