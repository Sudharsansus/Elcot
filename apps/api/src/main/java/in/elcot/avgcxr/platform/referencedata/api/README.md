# `apps/api/src/main/java/in/elcot/avgcxr/platform/referencedata/api`
...
- [`rest/`](rest/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/referencedata/api`).
