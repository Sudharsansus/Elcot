...
/**
 * Output port for user consent records. Implemented by UserConsentPersistenceAdapter
 * in infrastructure/persistence/. The application layer depends only on this interface.
 */
