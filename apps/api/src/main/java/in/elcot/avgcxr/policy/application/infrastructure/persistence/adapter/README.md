# `apps/api/src/main/java/in/elcot/avgcxr/policy/application/infrastructure/persistence/adapter`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/application/infrastructure/persistence`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `ApplicationRepositoryAdapter.java` | Java | Application Repository Adapter — data-access / port (persistence or external boundary). |
