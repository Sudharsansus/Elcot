# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/talentconnect/application/service`
...
| --- | --- | --- |
| `TalentProfileUseCaseService.java` | Java | Talent Profile Use Case Service — service (business logic). |
| `TalentconnectService.java` | Java | Talentconnect Service — service (business logic). |
