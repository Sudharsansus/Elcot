# `apps/api/src/main/java/in/elcot/avgcxr/policy/application/infrastructure/persistence/repository`
...
| --- | --- | --- |
| `JpaApplicationRepository.java` | Java | Jpa Application Repository — data-access / port (persistence or external boundary). |
