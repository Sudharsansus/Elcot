# `apps/api/src/main/java/in/elcot/avgcxr/policy/workflow/infrastructure/workflow`
...
| --- | --- | --- |
| `WorkflowWorkflowHandler.java` | Java | Workflow Workflow Handler — handler component. |
