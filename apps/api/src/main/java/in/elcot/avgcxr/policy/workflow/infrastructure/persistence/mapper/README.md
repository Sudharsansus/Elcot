# `apps/api/src/main/java/in/elcot/avgcxr/policy/workflow/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `WorkflowInstanceMapper.java` | Java | Workflow Instance Mapper — mapper (entity ↔ DTO conversion). |
| `WorkflowMapper.java` | Java | Workflow Mapper — mapper (entity ↔ DTO conversion). |
