# `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/infrastructure/persistence/repository`
...
| --- | --- | --- |
| `JpaAuthRepository.java` | Java | Jpa Auth Repository — data-access / port (persistence or external boundary). |
