# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/api/rest/dto/response`
...
| --- | --- | --- |
| `DocumentResponse.java` | Java | Document Response — data transfer object (API payload). |
