# `apps/api/src/main/java/in/elcot/avgcxr/analytics/reporting/infrastructure/persistence/repository`
...
| --- | --- | --- |
| `JpaReportDataRepository.java` | Java | Jpa Report Data Repository — data-access / port (persistence or external boundary). |
