# `apps/api/src/main/java/in/elcot/avgcxr/policy/application/api/rest/dto/request`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/application/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `CreateApplicationRequest.java` | Java | Create Application Request — data transfer object (API payload). |
| `UpdateApplicationRequest.java` | Java | Update Application Request — data transfer object (API payload). |
