# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/talentconnect/domain/model`
...
| --- | --- | --- |
| `TalentProfile.java` | Java | Talent Profile — Java class. |
| `Talentconnect.java` | Java | Talentconnect — Java class. |
| `TalentconnectId.java` | Java | Talentconnect Id — Java class. |
