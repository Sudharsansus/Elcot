# `apps/api/src/main/java/in/elcot/avgcxr/platform/file/api/rest/dto/response`
...
| --- | --- | --- |
| `FileMetadataResponse.java` | Java | File Metadata Response — data transfer object (API payload). |
| `FileResponse.java` | Java | File Response — data transfer object (API payload). |
