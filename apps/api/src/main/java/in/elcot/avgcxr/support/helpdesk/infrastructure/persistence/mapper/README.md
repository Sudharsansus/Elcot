# `apps/api/src/main/java/in/elcot/avgcxr/support/helpdesk/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `HelpdeskMapper.java` | Java | Helpdesk Mapper — mapper (entity ↔ DTO conversion). |
| `HelpdeskTicketMapper.java` | Java | Helpdesk Ticket Mapper — mapper (entity ↔ DTO conversion). |
