# `apps/api/src/main/java/in/elcot/avgcxr/support/helpdesk/api/rest/dto/request`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/support/helpdesk/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `CreateHelpdeskRequest.java` | Java | Create Helpdesk Request — data transfer object (API payload). |
| `UpdateHelpdeskRequest.java` | Java | Update Helpdesk Request — data transfer object (API payload). |
