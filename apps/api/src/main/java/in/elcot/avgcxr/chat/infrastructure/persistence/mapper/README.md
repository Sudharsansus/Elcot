# `apps/api/src/main/java/in/elcot/avgcxr/chat/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `ChatMessageMapper.java` | Java | Chat Message Mapper — mapper (entity ↔ DTO conversion). |
| `ChatSessionMapper.java` | Java | Chat Session Mapper — mapper (entity ↔ DTO conversion). |
