# `apps/api/src/main/java/in/elcot/avgcxr/common`
...
- [`api/`](api/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/common`).
- [`infrastructure/`](infrastructure/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/common`).
