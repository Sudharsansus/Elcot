# `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/infrastructure/persistence/adapter`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/infrastructure/persistence`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `GrievanceRepositoryAdapter.java` | Java | Grievance Repository Adapter — data-access / port (persistence or external boundary). |
