# `apps/api/src/main/java/in/elcot/avgcxr/platform/user/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `UserMapper.java` | Java | User Mapper — mapper (entity ↔ DTO conversion). |
| `UserProfileMapper.java` | Java | User Profile Mapper — mapper (entity ↔ DTO conversion). |
