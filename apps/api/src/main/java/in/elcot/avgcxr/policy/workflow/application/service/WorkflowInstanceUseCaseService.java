...
@Slf4j
public class WorkflowInstanceUseCaseService
    implements CreateWorkflowInstanceUseCase, GetWorkflowInstanceUseCase {
  ...
  public WorkflowInstanceResponse getById(UUID id) {
    WorkflowInstanceEntity e =
        repo.findById(id).orElseThrow(() -> new WorkflowInstanceNotFoundException(id));
    return toResponse(e);
  }
