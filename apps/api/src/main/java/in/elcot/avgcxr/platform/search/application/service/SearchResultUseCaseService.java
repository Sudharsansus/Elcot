...
@Slf4j
public class SearchResultUseCaseService
    implements CreateSearchResultUseCase, GetSearchResultUseCase {
  ...
  public SearchResultResponse getById(UUID id) {
    SearchResultEntity e =
        repo.findById(id).orElseThrow(() -> new SearchResultNotFoundException(id));
    return toResponse(e);
  }
