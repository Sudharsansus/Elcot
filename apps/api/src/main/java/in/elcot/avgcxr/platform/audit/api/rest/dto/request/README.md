# `apps/api/src/main/java/in/elcot/avgcxr/platform/audit/api/rest/dto/request`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/audit/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `CreateAuditRequest.java` | Java | Create Audit Request — data transfer object (API payload). |
| `UpdateAuditRequest.java` | Java | Update Audit Request — data transfer object (API payload). |
