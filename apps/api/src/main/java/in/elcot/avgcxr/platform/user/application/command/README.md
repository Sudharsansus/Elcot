# `apps/api/src/main/java/in/elcot/avgcxr/platform/user/application/command`
...
| --- | --- | --- |
| `CreateUserCommand.java` | Java | Create User Command — Java class. |
| `CreateUserProfileCommand.java` | Java | Create User Profile Command — Java class. |
| `UpdateUserCommand.java` | Java | Update User Command — Java class. |
