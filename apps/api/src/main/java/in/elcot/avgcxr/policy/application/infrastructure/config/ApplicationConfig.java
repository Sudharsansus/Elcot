 ...
 *
 * <ul>
 *   <li>Application state machine timing (auto-archive after N days)
 *   <li>Eligibility cache TTL
 *   <li>Daily deadline reminder scheduler
 * </ul>
 */
@Configuration
@EnableScheduling
public class ApplicationConfig {
  ...
  public ApplicationTtls applicationTtls() {
    return new ApplicationTtls(Duration.ofDays(draftTtlDays), Duration.ofDays(archiveAfterDays));
  }
  ...
  @Scheduled(
      cron = "${avgcxr.application.deadline-reminder-cron:0 0 9 * * *}",
  ...
  public static class ApplicationMetrics {
    ...
    private final java.util.concurrent.atomic.AtomicLong approved =
        new java.util.concurrent.atomic.AtomicLong();
