# `apps/api/src/main/java/in/elcot/avgcxr/policy/workflow/api/rest/dto/request`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/workflow/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `CreateWorkflowRequest.java` | Java | Create Workflow Request — data transfer object (API payload). |
| `UpdateWorkflowRequest.java` | Java | Update Workflow Request — data transfer object (API payload). |
