# `apps/api/src/main/java/in/elcot/avgcxr/platform/referencedata`
...
- [`api/`](api/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/referencedata`).
- [`infrastructure/`](infrastructure/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/referencedata`).
