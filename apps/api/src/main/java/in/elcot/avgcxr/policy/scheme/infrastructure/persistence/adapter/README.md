# `apps/api/src/main/java/in/elcot/avgcxr/policy/scheme/infrastructure/persistence/adapter`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/scheme/infrastructure/persistence`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `SchemeRepositoryAdapter.java` | Java | Scheme Repository Adapter — data-access / port (persistence or external boundary). |
