# `apps/api/src/main/java/in/elcot/avgcxr/analytics/chatbot/api/rest`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/analytics/chatbot/api`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `MiraController.java` | Java | Mira Controller — REST controller (defines HTTP endpoints). |
