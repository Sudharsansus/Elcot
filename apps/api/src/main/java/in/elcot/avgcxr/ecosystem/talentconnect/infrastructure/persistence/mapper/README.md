# `apps/api/src/main/java/in/elcot/avgcxr/ecosystem/talentconnect/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `TalentProfileMapper.java` | Java | Talent Profile Mapper — mapper (entity ↔ DTO conversion). |
| `TalentconnectMapper.java` | Java | Talentconnect Mapper — mapper (entity ↔ DTO conversion). |
