# `apps/api/src/main/java/in/elcot/avgcxr/platform/search/application/service`
...
| --- | --- | --- |
| `SearchResultUseCaseService.java` | Java | Search Result Use Case Service — service (business logic). |
| `SearchService.java` | Java | Search Service — service (business logic). |
