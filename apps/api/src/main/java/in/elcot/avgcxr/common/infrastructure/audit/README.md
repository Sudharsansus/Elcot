# `apps/api/src/main/java/in/elcot/avgcxr/common/infrastructure/audit`
...
| --- | --- | --- |
| `AuditAspect.java` | Java | Audit Aspect — aspect component. |
| `AuditLogEntry.java` | Java | Audit Log Entry — Java class. |
