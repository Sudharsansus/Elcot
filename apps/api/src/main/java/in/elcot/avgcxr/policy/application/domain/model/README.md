# `apps/api/src/main/java/in/elcot/avgcxr/policy/application/domain/model`
...
| --- | --- | --- |
| `Application.java` | Java | Application — Spring Boot application entry point. |
| `ApplicationId.java` | Java | Application Id — Java class. |
| `ApplicationStatus.java` | Java | Application Status — Java class. |
