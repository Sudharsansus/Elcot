 ...
 *
 * <p>Activated when {@code avgcxr.llm.provider=ollama}. Useful for
 * air-gapped deployments or when no API key is available.</p>
 *
 * <p>Default model: llama3.1:8b. Override with
 * {@code avgcxr.llm.ollama.model=qwen2.5:7b} (Qwen has good Tamil support)
 * or {@code avgcxr.llm.ollama.model=mistral:7b}.</p>
 */
@Service
...
public class OllamaProvider implements LlmProvider {
    ...
    public LlmResponse complete(String systemPrompt, List<Map<String, String>> messages, LlmOptions options) {
        ...
        try {
            ...
            messages.forEach(m -> msgs.add(Map.of(
                    "role", m.get("role"),
