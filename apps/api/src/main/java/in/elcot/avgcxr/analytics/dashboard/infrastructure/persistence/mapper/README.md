# `apps/api/src/main/java/in/elcot/avgcxr/analytics/dashboard/infrastructure/persistence/mapper`
...
| --- | --- | --- |
| `DashboardDataMapper.java` | Java | Dashboard Data Mapper — mapper (entity ↔ DTO conversion). |
