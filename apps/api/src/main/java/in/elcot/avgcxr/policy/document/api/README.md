# `apps/api/src/main/java/in/elcot/avgcxr/policy/document/api`
...
- [`messaging/`](messaging/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/document/api`).
- [`rest/`](rest/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/policy/document/api`).
