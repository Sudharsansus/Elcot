# `apps/api/src/main/java/in/elcot/avgcxr/analytics/reporting/infrastructure/persistence/entity`
...
| --- | --- | --- |
| `ReportDataEntity.java` | Java | Report Data Entity — JPA entity (maps to a database table). |
