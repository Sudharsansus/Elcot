...
import in.elcot.avgcxr.platform.audit.domain.exception.DuplicateAuditException;
...
public class AuditService implements CreateAuditUseCase, GetAuditUseCase {
    ...
    public AuditService(AuditRepositoryPort repository) { this.repository = repository; }
    ...
    @Override
    public Optional<Audit> findById(AuditId id) { return repository.findById(id); }
    ...
    @Transactional
    public void delete(AuditId id) { repository.deleteById(id); }
}
