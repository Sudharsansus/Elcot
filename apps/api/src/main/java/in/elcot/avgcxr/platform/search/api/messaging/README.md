# `apps/api/src/main/java/in/elcot/avgcxr/platform/search/api/messaging`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/search/api`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `SearchEventConsumer.java` | Java | Search Event Consumer — Java class. |
