...
@Slf4j
public class FileMetadataUseCaseService
    implements CreateFileMetadataUseCase, GetFileMetadataUseCase {
  ...
  public FileMetadataResponse getById(UUID id) {
    FileMetadataEntity e =
        repo.findById(id).orElseThrow(() -> new FileMetadataNotFoundException(id));
    return toResponse(e);
  }
