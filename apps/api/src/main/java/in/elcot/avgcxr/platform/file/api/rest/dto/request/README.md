# `apps/api/src/main/java/in/elcot/avgcxr/platform/file/api/rest/dto/request`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/file/api/rest/dto`).

## Files (2)

| File | Type | What it does |
| --- | --- | --- |
| `CreateFileRequest.java` | Java | Create File Request — data transfer object (API payload). |
| `UpdateFileRequest.java` | Java | Update File Request — data transfer object (API payload). |
