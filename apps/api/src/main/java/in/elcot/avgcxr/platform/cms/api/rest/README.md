# `apps/api/src/main/java/in/elcot/avgcxr/platform/cms/api/rest`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/cms/api`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `CmsController.java` | Java | Cms Controller — REST controller (defines HTTP endpoints). |
