# `apps/api/src/main/java/in/elcot/avgcxr/support/grievance/application/service`
...
| --- | --- | --- |
| `GrievanceUseCaseService.java` | Java | Grievance Use Case Service — service (business logic). |
