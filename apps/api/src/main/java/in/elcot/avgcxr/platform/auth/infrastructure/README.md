# `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/infrastructure`
...
- [`persistence/`](persistence/README.md) — Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/infrastructure`).
