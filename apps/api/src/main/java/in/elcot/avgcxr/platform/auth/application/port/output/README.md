# `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/application/port/output`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/platform/auth/application/port`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `AuthRepositoryPort.java` | Java | Auth Repository Port — data-access / port (persistence or external boundary). |
