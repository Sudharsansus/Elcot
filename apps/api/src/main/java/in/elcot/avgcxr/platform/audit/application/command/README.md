# `apps/api/src/main/java/in/elcot/avgcxr/platform/audit/application/command`
...
| --- | --- | --- |
| `CreateAuditCommand.java` | Java | Create Audit Command — Java class. |
| `CreateAuditLogCommand.java` | Java | Create Audit Log Command — Java class. |
| `UpdateAuditCommand.java` | Java | Update Audit Command — Java class. |
