# `apps/api/src/main/java/in/elcot/avgcxr/common/infrastructure/storage`
...
**Purpose:** Folder holding the files listed below (part of `apps/api/src/main/java/in/elcot/avgcxr/common/infrastructure`).

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `MinIOFileStorageAdapter.java` | Java | Min IOFile Storage Adapter — data-access / port (persistence or external boundary). |
