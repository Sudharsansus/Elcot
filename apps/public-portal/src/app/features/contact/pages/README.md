# `apps/public-portal/src/app/features/contact/pages`
...
| --- | --- | --- |
| `contact.component.html` | HTML | Office info |
| `contact.component.scss` | Sass | CONTACT PAGE STYLES |
| `contact.component.ts` | TypeScript | PUBLIC PORTAL — CONTACT PAGE Drop into: apps/public-portal/src/app/features/contact/pages/ (new directory) |
