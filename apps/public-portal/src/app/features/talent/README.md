# `apps/public-portal/src/app/features/talent`
...
**Purpose:** Talent Connect — professionals registry.

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `talent.routes.ts` | TypeScript | Route definitions for the Talent area (lazy-loaded screens). |
