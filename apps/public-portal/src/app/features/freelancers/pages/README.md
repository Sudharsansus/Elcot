# `apps/public-portal/src/app/features/freelancers/pages`
...
| --- | --- | --- |
| `freelancer-list.component.ts` | TypeScript | Freelancer List — UI component (template + logic for a screen or widget). |
