# `apps/public-portal/src/app/features/freelancers`
...
**Purpose:** Freelancer registry feature.

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `freelancers.routes.ts` | TypeScript | Route definitions for the Freelancers area (lazy-loaded screens). |
