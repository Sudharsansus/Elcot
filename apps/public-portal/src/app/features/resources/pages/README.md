# `apps/public-portal/src/app/features/resources/pages`
...
| --- | --- | --- |
| `resource-list.component.ts` | TypeScript | Resource List — UI component (template + logic for a screen or widget). |
