# `apps/public-portal/src/app/features/resources`
...
**Purpose:** Resources & policy-documents feature.

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `resources.routes.ts` | TypeScript | Route definitions for the Resources area (lazy-loaded screens). |
