# `apps/public-portal/src/app/features/companies/pages`
...
| --- | --- | --- |
| `company-list.component.ts` | TypeScript | Company List — UI component (template + logic for a screen or widget). |
