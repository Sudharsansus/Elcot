# `apps/public-portal/src/app/features/companies`
...
**Purpose:** Business Connect — company/studio directory.

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `companies.routes.ts` | TypeScript | Route definitions for the Companies area (lazy-loaded screens). |
