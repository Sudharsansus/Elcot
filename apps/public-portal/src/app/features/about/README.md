# `apps/public-portal/src/app/features/about`
...
**Purpose:** About / static informational pages.

## Files (1)

| File | Type | What it does |
| --- | --- | --- |
| `about.routes.ts` | TypeScript | Route definitions for the About area (lazy-loaded screens). |
