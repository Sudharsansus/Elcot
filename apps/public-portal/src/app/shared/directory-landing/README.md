# `apps/public-portal/src/app/shared/directory-landing`
...
| --- | --- | --- |
| `directory-landing.component.ts` | TypeScript | DIRECTORY LANDING — honest shell for registry pages Companies / Talent / Freelancers have no seeded data in the repo. … |
