# `apps/public-portal/src/assets/brand`
...
**Purpose:** Folder holding the files listed below (part of `apps/public-portal/src/assets`).

## Files (3)

| File | Type | What it does |
| --- | --- | --- |
| `elcot-logo.png` | PNG | Raster image asset. |
| `favicon.svg` | SVG | Vector graphic asset. |
| `tn-emblem.png` | PNG | Raster image asset. |
