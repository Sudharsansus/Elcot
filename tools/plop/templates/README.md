...
**Purpose:** Folder holding the files listed below (part of `tools/plop`).

_No files directly in this folder (see subfolders below)._

## Subfolders (2)

- [`angular-feature/`](angular-feature/README.md) — Folder holding the files listed below (part of `tools/plop/templates`).
- [`spring-service/`](spring-service/README.md) — Folder holding the files listed below (part of `tools/plop/templates`).
