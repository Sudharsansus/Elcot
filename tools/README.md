...
**Purpose:** Repo tooling and generators.

_No files directly in this folder (see subfolders below)._

## Subfolders (3)

- [`codemods/`](codemods/README.md) — Folder holding the files listed below (part of `tools`).
- [`plop/`](plop/README.md) — Folder holding the files listed below (part of `tools`).
- [`scripts/`](scripts/README.md) — Developer / operational scripts.
