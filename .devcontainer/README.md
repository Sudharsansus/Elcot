...
**Purpose:** Folder holding the files listed below (part of `the project`).

## Files (3)

| File | Type | What it does |
| --- | --- | --- |
| `Dockerfile` | file | Container build recipe for this service. |
| `devcontainer.json` | JSON | JSON data / configuration. |
| `post-create.sh` | SH | Shell script. |
